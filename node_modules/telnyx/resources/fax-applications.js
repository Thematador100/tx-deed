...
class FaxApplications extends resource_1.APIResource {
    /**
     ...
     */
    retrieve(id, options) {
        return this._client.get((0, path_1.path) `/fax_applications/${id}`, options);
    }
    /**
    ...
    update(id, body, options) {
        return this._client.patch((0, path_1.path) `/fax_applications/${id}`, { body, ...options });
    }
    /**
     ...
     */
    delete(id, options) {
        return this._client.delete((0, path_1.path) `/fax_applications/${id}`, options);
    }
}
exports.FaxApplications = FaxApplications;
//# sourceMappingURL=fax-applications.js.map