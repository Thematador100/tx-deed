...
export declare class Calls extends APIResource {
     ...
     * ```
     */
    initiate(applicationID: string, body: CallInitiateParams, options?: RequestOptions): APIPromise<CallInitiateResponse>;
}
export interface CallUpdateResponse {
    data?: CallUpdateResponse.Data;
}
export declare namespace CallUpdateResponse {
    interface Data {
        sid?: string;
        status?: string;
    }
...
export declare namespace CallInitiateResponse {
    interface Data {
        from?: string;
        status?: string;
        to?: string;
...
export declare namespace Calls {
    export { type CallUpdateResponse as CallUpdateResponse, type CallInitiateResponse as CallInitiateResponse, type CallUpdateParams as CallUpdateParams, type CallInitiateParams as CallInitiateParams, };
}
