...
export declare class PhoneNumberAssignmentByProfile extends APIResource {
    /**
     ...
     * ```ts
     * const response =
     *   await client.phoneNumberAssignmentByProfile.assign({
     *     messagingProfileId:
     ...
     * ```ts
     * const response =
     *   await client.phoneNumberAssignmentByProfile.retrieveStatus(
     *     'taskId',
     *   );
     * ```
     */
...
export type PhoneNumberAssignmentByProfileAssignResponse = PhoneNumberAssignmentByProfileAssignResponse.AssignProfileToCampaignResponse | PhoneNumberAssignmentByProfileAssignResponse.SettingsDataErrorMessage;
export declare namespace PhoneNumberAssignmentByProfileAssignResponse {
    interface AssignProfileToCampaignResponse {
        /**
    ...
    interface SettingsDataErrorMessage {
        message: string;
    }
}
...
export declare namespace PhoneNumberAssignmentByProfileRetrievePhoneNumberStatusResponse {
    interface Record {
        /**
