...
export declare class Documents extends APIResource {
     ...
     * ```
     */
    update(id: string, body: DocumentUpdateParams, options?: RequestOptions): APIPromise<DocumentUpdateResponse>;
    /**
     ...
     * ```
     */
    uploadJson(body: DocumentUploadJsonParams, options?: RequestOptions): APIPromise<DocumentUploadJsonResponse>;
}
...
export declare namespace DocServiceDocument {
    /**
     * Indicates the document's filesize
     */
    interface Size {
...
export declare namespace DocumentGenerateDownloadLinkResponse {
    interface Data {
        /**
...
export type DocumentUploadParams = DocumentUploadParams.DocServiceDocumentUploadURL | DocumentUploadParams.DocServiceDocumentUploadInline;
export declare namespace DocumentUploadParams {
    interface DocServiceDocumentUploadURL {
        /**
    ...
    interface DocServiceDocumentUploadInline {
        /**
...
export type DocumentUploadJsonParams = DocumentUploadJsonParams.DocServiceDocumentUploadURL | DocumentUploadJsonParams.DocServiceDocumentUploadInline;
