...
export declare class AuditEvents extends APIResource {
    /**
...
export declare namespace AuditEventListResponse {
    interface Data {
        /**
...
export declare namespace AuditEventListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[created_before], filter[created_after]
     */
...
export declare namespace AuditEvents {
    export { type AuditEventListResponse as AuditEventListResponse, type AuditEventListParams as AuditEventListParams, };
}
//# sourceMappingURL=audit-events.d.mts.map