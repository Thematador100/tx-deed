...
import * as RcsAPI from "./rcs.mjs";
import { RcGenerateDeeplinkParams, RcGenerateDeeplinkResponse, Rcs } from "./rcs.mjs";
...
export declare namespace MessagingError {
    interface Source {
        /**
...
export declare namespace OutboundMessagePayload {
    interface Cost {
        /**
...
export declare namespace MessageRetrieveResponse {
    ...
    namespace InboundMessagePayload {
        interface Cc {
            /**
             * The carrier of the receiver.
             */
...
export declare namespace MessageCancelScheduledResponse {
    interface Cost {
        /**
         * The amount deducted from your account.
         */
