...
import * as BucketsAPI from "./buckets.mjs";
import { BucketListResponse, BucketRetrieveResponse, Buckets } from "./buckets.mjs";
...
export declare namespace EmbeddingRetrieveResponse {
    interface Data {
        created_at?: string;
        finished_at?: string;
        /**
...
export declare namespace EmbeddingListResponse {
    interface Data {
        created_at: string;
        /**
         * Status of an embeddings task.
...
export declare namespace EmbeddingSimilaritySearchResponse {
    /**
