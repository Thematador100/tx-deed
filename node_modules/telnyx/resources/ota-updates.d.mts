...
export declare class OtaUpdates extends APIResource {
    /**
     ...
     * List OTA updates
     */
    list(query?: OtaUpdateListParams | null | undefined, options?: RequestOptions): APIPromise<OtaUpdateListResponse>;
}
...
export declare namespace OtaUpdateRetrieveResponse {
    /**
     * This object represents an Over the Air (OTA) update request. It allows tracking
     * the current status of a operation that apply settings in a particular SIM card.
     * <br/><br/>
    ...
    namespace Data {
        ...
        namespace Settings {
            interface MobileNetworkOperatorsPreference {
                /**
...
export declare namespace OtaUpdateListResponse {
    /**
     * This object represents an Over the Air (OTA) update request. It allows tracking
     * the current status of a operation that apply settings in a particular SIM card.
     * <br/><br/>
...
export declare namespace OtaUpdateListParams {
    /**
     * Consolidated filter parameter for OTA updates (deepObject style). Originally:
     * filter[status], filter[sim_card_id], filter[type]
     */
...
export declare namespace OtaUpdates {
    export { type OtaUpdateRetrieveResponse as OtaUpdateRetrieveResponse, type OtaUpdateListResponse as OtaUpdateListResponse, type OtaUpdateListParams as OtaUpdateListParams, };
}
//# sourceMappingURL=ota-updates.d.mts.map