"""
Washoe County, Nevada Tax Deed/Lien Scraper
...
class WashoeScraper(BaseScraper):
    """Scraper for Washoe County, Nevada"""

    def __init__(self):
        super().__init__(
            county_name="Washoe",
            state_code="NV",
            base_url="https://www.washoecounty.gov/treasurer"
        )
