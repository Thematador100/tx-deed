...
export declare namespace PhoneNumberWithVoiceSettings {
    /**
     * The emergency services settings for a phone number.
     */
    interface Emergency {
...
export declare namespace ActionVerifyOwnershipResponse {
    interface Data {
        /**
