...
export declare class CustomerServiceRecords extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: CustomerServiceRecordListParams | null | undefined, options?: RequestOptions): APIPromise<CustomerServiceRecordListResponse>;
    /**
...
export declare namespace CustomerServiceRecord {
    /**
     * The result of the CSR request. This field would be null in case of `pending` or
     * `failed` status.
     */
...
export declare namespace CustomerServiceRecordVerifyPhoneNumberCoverageResponse {
    interface Data {
        /**
...
export declare namespace CustomerServiceRecordCreateParams {
...
export declare namespace CustomerServiceRecordListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[phone_number][eq], filter[phone_number][in][], filter[status][eq],
     * filter[status][in][], filter[created_at][lt], filter[created_at][gt]
