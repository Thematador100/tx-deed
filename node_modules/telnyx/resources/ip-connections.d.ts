...
export declare class IPConnections extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: IPConnectionListParams | null | undefined, options?: RequestOptions): APIPromise<IPConnectionListResponse>;
    /**
...
export declare namespace IPConnectionCreateParams {
    interface Inbound {
        /**
         * This setting allows you to set the format with which the caller's number (ANI)
         * is sent for inbound phone calls.
...
export declare namespace IPConnectionListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[connection_name], filter[fqdn], filter[outbound_voice_profile_id],
     * filter[outbound.outbound_voice_profile_id]
