...
export declare class PhoneNumberExtensions extends APIResource {
    /**
     ...
     * ```
     */
    list(portingOrderID: string, query?: PhoneNumberExtensionListParams | null | undefined, options?: RequestOptions): APIPromise<PhoneNumberExtensionListResponse>;
    /**
...
export declare namespace PortingPhoneNumberExtension {
...
export declare namespace PhoneNumberExtensionCreateParams {
    interface ActivationRange {
        /**
         * Specifies the end of the activation range. It must be no more than the end of
         * the extension range.
...
export declare namespace PhoneNumberExtensionListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[porting_phone_number_id]
     */
