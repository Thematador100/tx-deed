...
import { LayoutDashboard, Users, CreditCard, Library, Zap, Bot, HeartHandshake, KeyRound, Building, Activity } from 'lucide-react';
...
const AdminLayout = ({ children }) => {
  ...
  const sidebarNavItems = [
    ...
    { title: "Scrapers", href: "/admin/scrapers", icon: Activity },
