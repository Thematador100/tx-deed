...
import * as CampaignAPI from "./campaign/campaign.mjs";
import { APIPromise } from "../core/api-promise.mjs";
import { RequestOptions } from "../internal/request-options.mjs";
export declare class PartnerCampaigns extends APIResource {
    /**
     ...
     * ```
     */
    update(campaignID: string, body: PartnerCampaignUpdateParams, options?: RequestOptions): APIPromise<TelnyxDownstreamCampaign>;
    /**
     ...
     * ```
     */
    list(query?: PartnerCampaignListParams | null | undefined, options?: RequestOptions): APIPromise<PartnerCampaignListResponse>;
    /**
     ...
     * ```
     */
    listSharedByMe(query?: PartnerCampaignListSharedByMeParams | null | undefined, options?: RequestOptions): APIPromise<PartnerCampaignListSharedByMeResponse>;
    /**
     * Get Sharing Status
     *
     * @example
     ...
     * ```
     */
    retrieveSharingStatus(campaignID: string, options?: RequestOptions): APIPromise<PartnerCampaignRetrieveSharingStatusResponse>;
}
/**
...
export declare namespace PartnerCampaignListSharedByMeResponse {
    /**
     * Campaign is generated by the 10DLC registry once the corresponding campaign
     * request is approved. Each campaign is assigned a unique identifier -
     * **campaignId**. Once a campaign is activated, limited information is published
...
export interface PartnerCampaignListParams {
     ...
     */
    sort?: 'assignedPhoneNumbersCount' | '-assignedPhoneNumbersCount' | 'brandDisplayName' | '-brandDisplayName' | 'tcrBrandId' | '-tcrBranId' | 'tcrCampaignId' | '-tcrCampaignId' | 'createdAt' | '-createdAt' | 'campaignStatus' | '-campaignStatus';
}
