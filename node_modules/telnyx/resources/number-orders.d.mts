...
export declare class NumberOrders extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: NumberOrderListParams | null | undefined, options?: RequestOptions): APIPromise<NumberOrderListResponse>;
}
...
export declare namespace NumberOrderListResponse {
    interface Data {
        id?: string;
        /**
         * Identifies the messaging profile associated with the phone number.
...
export declare namespace NumberOrderCreateParams {
    interface PhoneNumber {
        /**
         * e164_phone_number
         */
...
export declare namespace NumberOrderListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally: filter[status],
     * filter[created_at], filter[phone_numbers_count], filter[customer_reference],
     * filter[requirements_met]
