...
export declare class ActionRequirements extends APIResource {
    /**
     ...
     * ```
     */
    list(portingOrderID: string, query?: ActionRequirementListParams | null | undefined, options?: RequestOptions): APIPromise<ActionRequirementListResponse>;
    /**
...
export declare namespace ActionRequirementListResponse {
    interface Data {
        /**
...
export declare namespace ActionRequirementInitiateResponse {
    interface Data {
        /**
         * Identifies the action requirement
         */
...
export declare namespace ActionRequirementListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally: filter[id][in][],
     * filter[requirement_type_id], filter[action_type], filter[status]
     */
...
export declare namespace ActionRequirementInitiateParams {
    /**
...
export declare namespace ActionRequirements {
    export { type ActionRequirementListResponse as ActionRequirementListResponse, type ActionRequirementInitiateResponse as ActionRequirementInitiateResponse, type ActionRequirementListParams as ActionRequirementListParams, type ActionRequirementInitiateParams as ActionRequirementInitiateParams, };
}
//# sourceMappingURL=action-requirements.d.mts.map