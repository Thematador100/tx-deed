...
export declare class AuthenticationProviders extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: AuthenticationProviderListParams | null | undefined, options?: RequestOptions): APIPromise<AuthenticationProviderListResponse>;
    /**
...
export declare namespace AuthenticationProvider {
    /**
     * The settings associated with the authentication provider.
     */
    interface Settings {
...
export declare namespace AuthenticationProviderListParams {
    /**
     * Consolidated page parameter (deepObject style). Originally: page[number],
     * page[size]
     */
...
export declare namespace AuthenticationProviders {
    export { type AuthenticationProvider as AuthenticationProvider, type PaginationMeta as PaginationMeta, type Settings as Settings, type AuthenticationProviderCreateResponse as AuthenticationProviderCreateResponse, type AuthenticationProviderRetrieveResponse as AuthenticationProviderRetrieveResponse, type AuthenticationProviderUpdateResponse as AuthenticationProviderUpdateResponse, type AuthenticationProviderListResponse as AuthenticationProviderListResponse, type AuthenticationProviderDeleteResponse as AuthenticationProviderDeleteResponse, type AuthenticationProviderCreateParams as AuthenticationProviderCreateParams, type AuthenticationProviderUpdateParams as AuthenticationProviderUpdateParams, type AuthenticationProviderListParams as AuthenticationProviderListParams, };
}
//# sourceMappingURL=authentication-providers.d.mts.map