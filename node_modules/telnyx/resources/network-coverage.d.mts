...
import * as NetworkCoverageAPI from "./network-coverage.mjs";
import * as AuthenticationProvidersAPI from "./authentication-providers.mjs";
import { APIPromise } from "../core/api-promise.mjs";
import { RequestOptions } from "../internal/request-options.mjs";
export declare class NetworkCoverage extends APIResource {
    /**
     * List all locations and the interfaces that region supports
     */
    list(query?: NetworkCoverageListParams | null | undefined, options?: RequestOptions): APIPromise<NetworkCoverageListResponse>;
}
...
export declare namespace NetworkCoverageListResponse {
    interface Data {
        /**
...
export declare namespace NetworkCoverageListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[location.region], filter[location.site], filter[location.pop],
     * filter[location.code]
...
export declare namespace NetworkCoverage {
    export { type AvailableService as AvailableService, type NetworkCoverageListResponse as NetworkCoverageListResponse, type NetworkCoverageListParams as NetworkCoverageListParams, };
}
//# sourceMappingURL=network-coverage.d.mts.map