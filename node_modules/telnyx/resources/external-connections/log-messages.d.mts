...
export declare class LogMessages extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: LogMessageListParams | null | undefined, options?: RequestOptions): APIPromise<LogMessageListResponse>;
    /**
...
export declare namespace LogMessageRetrieveResponse {
...
export declare namespace LogMessageListResponse {
    interface LogMessage {
        code: string;
        title: string;
        detail?: string;
...
export declare namespace LogMessageListParams {
    /**
     * Filter parameter for log messages (deepObject style). Supports filtering by
     * external_connection_id and telephone_number with eq/contains operations.
     */
...
export declare namespace LogMessages {
    export { type LogMessageRetrieveResponse as LogMessageRetrieveResponse, type LogMessageListResponse as LogMessageListResponse, type LogMessageDismissResponse as LogMessageDismissResponse, type LogMessageListParams as LogMessageListParams, };
}
//# sourceMappingURL=log-messages.d.mts.map