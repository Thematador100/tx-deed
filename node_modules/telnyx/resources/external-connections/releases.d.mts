...
export declare class Releases extends APIResource {
     ...
     * ```
     */
    list(id: string, query?: ReleaseListParams | null | undefined, options?: RequestOptions): APIPromise<ReleaseListResponse>;
}
...
export declare namespace ReleaseListParams {
    /**
     * Filter parameter for releases (deepObject style). Supports filtering by status,
     * civic_address_id, location_id, and phone_number with eq/contains operations.
     */
...
export declare namespace Releases {
    export { type ReleaseRetrieveResponse as ReleaseRetrieveResponse, type ReleaseListResponse as ReleaseListResponse, type ReleaseRetrieveParams as ReleaseRetrieveParams, type ReleaseListParams as ReleaseListParams, };
}
