...
import { ActionDeleteParams, Actions } from "./actions.mjs";
...
export declare class Recordings extends APIResource {
     ...
     * ```
     */
    list(query?: RecordingListParams | null | undefined, options?: RequestOptions): APIPromise<RecordingListResponse>;
    /**
...
export declare namespace RecordingResponseData {
    /**
     * Links to download the recording files.
     */
...
export declare namespace RecordingListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[conference_id], filter[created_at][gte], filter[created_at][lte],
     * filter[call_leg_id], filter[call_session_id], filter[from], filter[to],
...
export declare namespace Recordings {
    export { type RecordingResponseData as RecordingResponseData, type RecordingRetrieveResponse as RecordingRetrieveResponse, type RecordingListResponse as RecordingListResponse, type RecordingDeleteResponse as RecordingDeleteResponse, type RecordingListParams as RecordingListParams, };
