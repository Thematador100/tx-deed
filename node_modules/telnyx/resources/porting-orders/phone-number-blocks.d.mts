...
export declare class PhoneNumberBlocks extends APIResource {
    /**
     ...
     * ```
     */
    list(portingOrderID: string, query?: PhoneNumberBlockListParams | null | undefined, options?: RequestOptions): APIPromise<PhoneNumberBlockListResponse>;
    /**
...
export declare namespace PortingPhoneNumberBlock {
...
export declare namespace PhoneNumberBlockCreateParams {
    interface ActivationRange {
        /**
         * Specifies the end of the activation range. It must be no more than the end of
         * the extension range.
...
export declare namespace PhoneNumberBlockListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[porting_order_id], filter[support_key], filter[status],
     * filter[phone_number], filter[activation_status], filter[portability_status]
