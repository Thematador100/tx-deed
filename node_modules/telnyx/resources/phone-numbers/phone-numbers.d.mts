...
import { ActionChangeBundleStatusParams, ActionChangeBundleStatusResponse, ActionEnableEmergencyParams, ActionEnableEmergencyResponse, ActionVerifyOwnershipParams, ActionVerifyOwnershipResponse, Actions, PhoneNumberWithVoiceSettings } from "./actions.mjs";
import * as CsvDownloadsAPI from "./csv-downloads.mjs";
import { CsvDownload, CsvDownloadCreateParams, CsvDownloadCreateResponse, CsvDownloadListParams, CsvDownloadListResponse, CsvDownloadRetrieveResponse, CsvDownloads } from "./csv-downloads.mjs";
import * as JobsAPI from "./jobs.mjs";
import { JobDeleteBatchParams, JobDeleteBatchResponse, JobListParams, JobListResponse, JobRetrieveResponse, JobUpdateBatchParams, JobUpdateBatchResponse, JobUpdateEmergencySettingsBatchParams, JobUpdateEmergencySettingsBatchResponse, Jobs, PhoneNumbersJob } from "./jobs.mjs";
import * as MessagingAPI from "./messaging.mjs";
import { Messaging, MessagingListParams, MessagingListResponse, MessagingRetrieveResponse, MessagingUpdateParams, MessagingUpdateResponse } from "./messaging.mjs";
import * as VoiceAPI from "./voice.mjs";
import { CallForwarding, CallRecording, CnamListing, MediaFeatures, UpdateVoiceSettings, Voice, VoiceListParams, VoiceListResponse, VoiceRetrieveResponse, VoiceUpdateParams, VoiceUpdateResponse } from "./voice.mjs";
import * as VoicemailAPI from "./voicemail.mjs";
import { Voicemail, VoicemailCreateParams, VoicemailCreateResponse, VoicemailPrefResponse, VoicemailRequest, VoicemailRetrieveResponse, VoicemailUpdateParams, VoicemailUpdateResponse } from "./voicemail.mjs";
import { APIPromise } from "../../core/api-promise.mjs";
import { RequestOptions } from "../../internal/request-options.mjs";
export declare class PhoneNumbers extends APIResource {
    actions: ActionsAPI.Actions;
    csvDownloads: CsvDownloadsAPI.CsvDownloads;
    jobs: JobsAPI.Jobs;
    messaging: MessagingAPI.Messaging;
    voice: VoiceAPI.Voice;
    voicemail: VoicemailAPI.Voicemail;
    /**
     ...
     * ```
     */
    update(id: string, body: PhoneNumberUpdateParams, options?: RequestOptions): APIPromise<PhoneNumberUpdateResponse>;
    /**
     * List phone numbers
     *
     * @example
     ...
     * ```
     */
    slimList(query?: PhoneNumberSlimListParams | null | undefined, options?: RequestOptions): APIPromise<PhoneNumberSlimListResponse>;
}
...
export declare namespace PhoneNumberDeleteResponse {
    interface Data {
        /**
         * Identifies the resource.
         */
...
export declare namespace PhoneNumberSlimListResponse {
    interface Data {
        /**
         * Identifies the resource.
         */
...
export declare namespace PhoneNumberListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally: filter[tag],
     * filter[phone_number], filter[status], filter[country_iso_alpha2],
     * filter[connection_id], filter[voice.connection_name],
...
export declare namespace PhoneNumberSlimListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally: filter[tag],
     * filter[phone_number], filter[status], filter[country_iso_alpha2],
     * filter[connection_id], filter[voice.connection_name],
...
export declare namespace PhoneNumbers {
    export { type PhoneNumberDetailed as PhoneNumberDetailed, type PhoneNumberRetrieveResponse as PhoneNumberRetrieveResponse, type PhoneNumberUpdateResponse as PhoneNumberUpdateResponse, type PhoneNumberListResponse as PhoneNumberListResponse, type PhoneNumberDeleteResponse as PhoneNumberDeleteResponse, type PhoneNumberSlimListResponse as PhoneNumberSlimListResponse, type PhoneNumberUpdateParams as PhoneNumberUpdateParams, type PhoneNumberListParams as PhoneNumberListParams, type PhoneNumberSlimListParams as PhoneNumberSlimListParams, };
    export { Actions as Actions, type PhoneNumberWithVoiceSettings as PhoneNumberWithVoiceSettings, type ActionChangeBundleStatusResponse as ActionChangeBundleStatusResponse, type ActionEnableEmergencyResponse as ActionEnableEmergencyResponse, type ActionVerifyOwnershipResponse as ActionVerifyOwnershipResponse, type ActionChangeBundleStatusParams as ActionChangeBundleStatusParams, type ActionEnableEmergencyParams as ActionEnableEmergencyParams, type ActionVerifyOwnershipParams as ActionVerifyOwnershipParams, };
    export { CsvDownloads as CsvDownloads, type CsvDownload as CsvDownload, type CsvDownloadCreateResponse as CsvDownloadCreateResponse, type CsvDownloadRetrieveResponse as CsvDownloadRetrieveResponse, type CsvDownloadListResponse as CsvDownloadListResponse, type CsvDownloadCreateParams as CsvDownloadCreateParams, type CsvDownloadListParams as CsvDownloadListParams, };
    export { Jobs as Jobs, type PhoneNumbersJob as PhoneNumbersJob, type JobRetrieveResponse as JobRetrieveResponse, type JobListResponse as JobListResponse, type JobDeleteBatchResponse as JobDeleteBatchResponse, type JobUpdateBatchResponse as JobUpdateBatchResponse, type JobUpdateEmergencySettingsBatchResponse as JobUpdateEmergencySettingsBatchResponse, type JobListParams as JobListParams, type JobDeleteBatchParams as JobDeleteBatchParams, type JobUpdateBatchParams as JobUpdateBatchParams, type JobUpdateEmergencySettingsBatchParams as JobUpdateEmergencySettingsBatchParams, };
    export { Messaging as Messaging, type MessagingRetrieveResponse as MessagingRetrieveResponse, type MessagingUpdateResponse as MessagingUpdateResponse, type MessagingListResponse as MessagingListResponse, type MessagingUpdateParams as MessagingUpdateParams, type MessagingListParams as MessagingListParams, };
    export { Voice as Voice, type CallForwarding as CallForwarding, type CallRecording as CallRecording, type CnamListing as CnamListing, type MediaFeatures as MediaFeatures, type UpdateVoiceSettings as UpdateVoiceSettings, type VoiceRetrieveResponse as VoiceRetrieveResponse, type VoiceUpdateResponse as VoiceUpdateResponse, type VoiceListResponse as VoiceListResponse, type VoiceUpdateParams as VoiceUpdateParams, type VoiceListParams as VoiceListParams, };
    export { Voicemail as Voicemail, type VoicemailPrefResponse as VoicemailPrefResponse, type VoicemailRequest as VoicemailRequest, type VoicemailCreateResponse as VoicemailCreateResponse, type VoicemailRetrieveResponse as VoicemailRetrieveResponse, type VoicemailUpdateResponse as VoicemailUpdateResponse, type VoicemailCreateParams as VoicemailCreateParams, type VoicemailUpdateParams as VoicemailUpdateParams, };
}
