...
import * as CredentialConnectionsAPI from "./credential-connections/credential-connections.js";
import { APIPromise } from "../core/api-promise.js";
import { RequestOptions } from "../internal/request-options.js";
export declare class TexmlApplications extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: TexmlApplicationListParams | null | undefined, options?: RequestOptions): APIPromise<TexmlApplicationListResponse>;
    /**
...
export declare namespace TexmlApplication {
    interface Inbound {
        /**
...
export declare namespace TexmlApplicationListResponse {
    interface Meta {
        page_number?: number;
        page_size?: number;
        total_pages?: number;
...
export declare namespace TexmlApplicationCreateParams {
    interface Inbound {
        /**
         * When set, this will limit the total number of inbound calls to phone numbers
         * associated with this connection.
...
export declare namespace TexmlApplicationUpdateParams {
    interface Inbound {
        /**
         * When set, this will limit the total number of inbound calls to phone numbers
         * associated with this connection.
...
export declare namespace TexmlApplicationListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[outbound_voice_profile_id], filter[friendly_name]
     */
