...
export declare class CallControlApplications extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: CallControlApplicationListParams | null | undefined, options?: RequestOptions): APIPromise<CallControlApplicationListResponse>;
    /**
...
export declare namespace CallControlApplicationListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[application_name][contains], filter[outbound.outbound_voice_profile_id],
     * filter[leg_id], filter[application_session_id], filter[connection_id],
