...
export declare class Reports extends APIResource {
     ...
     * ```
     */
    list(query?: ReportListParams | null | undefined, options?: RequestOptions): APIPromise<ReportListResponse>;
}
/**
...
export declare namespace ExportPortingOrdersCsvReport {
    /**
     * The filters to apply to the export porting order CSV report.
     */
    interface Filters {
...
export declare namespace ReportListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[report_type], filter[status]
     */
