...
export declare class Insights extends APIResource {
     ...
     * ```
     */
    update(insightID: string, body: InsightUpdateParams, options?: RequestOptions): APIPromise<InsightTemplateDetail>;
    /**
     * Get all insights
     *
     * @example
     ...
     * ```
     */
    list(query?: InsightListParams | null | undefined, options?: RequestOptions): APIPromise<InsightListResponse>;
    /**
...
export declare namespace InsightListParams {
    /**
     * Consolidated page parameter (deepObject style). Originally: page[number],
     * page[size]
     */
