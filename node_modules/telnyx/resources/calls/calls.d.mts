...
export declare namespace CallDialResponse {
    interface Data {
        /**
...
export declare namespace CallRetrieveStatusResponse {
    interface Data {
        /**
         * Unique identifier and token for controlling the call.
         */
...
export declare namespace CallDialParams {
    /**
     * Optional configuration parameters to modify 'answering_machine_detection'
     * performance.
     */
