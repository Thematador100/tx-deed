...
import { CountryCoverage, } from "./resources/country-coverage.mjs";
...
import { Enum } from "./resources/enum.mjs";
...
import { Messsages, } from "./resources/messsages.mjs";
...
import { PartnerCampaigns, } from "./resources/partner-campaigns.mjs";
import { PhoneNumberAssignmentByProfile, } from "./resources/phone-number-assignment-by-profile.mjs";
import { PhoneNumberCampaigns, } from "./resources/phone-number-campaigns.mjs";
...
import { SubNumberOrdersReport, } from "./resources/sub-number-orders-report.mjs";
...
import { TextToSpeech, } from "./resources/text-to-speech.mjs";
...
import { Brand, } from "./resources/brand/brand.mjs";
import { BundlePricing } from "./resources/bundle-pricing/bundle-pricing.mjs";
import { Calls, } from "./resources/calls/calls.mjs";
import { CampaignBuilder, } from "./resources/campaign-builder/campaign-builder.mjs";
import { Campaign, } from "./resources/campaign/campaign.mjs";
...
export class Telnyx {
     ...
     */
    constructor({ baseURL = readEnv('TELNYX_BASE_URL'), apiKey = readEnv('TELNYX_API_KEY'), publicKey = readEnv('TELNYX_PUBLIC_KEY') ?? null, ...opts } = {}) {
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return __classPrivateFieldGet(this, _Telnyx_encoder, "f").call(this, { body, headers });
        }
    }
}
