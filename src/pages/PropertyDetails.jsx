...
const PropertyDetails = () => {
  ...
  useEffect(() => {
    const fetchProperty = async () => {
      ...
      if (error || !data) {
        console.error('Could not fetch property from database:', error);
        toast({
          title: "Property Not Found",
          description: "The requested property could not be found. Please check the URL or return to the properties list.",
          variant: "destructive",
        });
        navigate('/properties');
      } else {
