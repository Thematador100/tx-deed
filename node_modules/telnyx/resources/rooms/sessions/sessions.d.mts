...
import * as RoomsAPI from "../rooms.mjs";
import * as ActionsAPI from "./actions.mjs";
import { ActionEndResponse, ActionKickParams, ActionKickResponse, ActionMuteParams, ActionMuteResponse, ActionUnmuteParams, ActionUnmuteResponse, Actions, ActionsParticipantsRequest } from "./actions.mjs";
...
export declare class Sessions extends APIResource {
     ...
     * ```
     */
    list0(query?: SessionList0Params | null | undefined, options?: RequestOptions): APIPromise<SessionList0Response>;
    /**
     * View a list of room sessions.
     *
     * @example
     ...
     * ```
     */
    list1(roomID: string, query?: SessionList1Params | null | undefined, options?: RequestOptions): APIPromise<SessionList1Response>;
    /**
     ...
     * ```
     */
    retrieveParticipants(roomSessionID: string, query?: SessionRetrieveParticipantsParams | null | undefined, options?: RequestOptions): APIPromise<SessionRetrieveParticipantsResponse>;
}
...
export declare namespace SessionList0Params {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[date_created_at][eq], filter[date_created_at][gte],
     * filter[date_created_at][lte], filter[date_updated_at][eq],
...
export declare namespace SessionList1Params {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[date_created_at][eq], filter[date_created_at][gte],
     * filter[date_created_at][lte], filter[date_updated_at][eq],
...
export declare namespace SessionRetrieveParticipantsParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[date_joined_at][eq], filter[date_joined_at][gte],
     * filter[date_joined_at][lte], filter[date_updated_at][eq],
...
export declare namespace Sessions {
    export { type SessionRetrieveResponse as SessionRetrieveResponse, type SessionList0Response as SessionList0Response, type SessionList1Response as SessionList1Response, type SessionRetrieveParticipantsResponse as SessionRetrieveParticipantsResponse, type SessionRetrieveParams as SessionRetrieveParams, type SessionList0Params as SessionList0Params, type SessionList1Params as SessionList1Params, type SessionRetrieveParticipantsParams as SessionRetrieveParticipantsParams, };
    export { Actions as Actions, type ActionsParticipantsRequest as ActionsParticipantsRequest, type ActionEndResponse as ActionEndResponse, type ActionKickResponse as ActionKickResponse, type ActionMuteResponse as ActionMuteResponse, type ActionUnmuteResponse as ActionUnmuteResponse, type ActionKickParams as ActionKickParams, type ActionMuteParams as ActionMuteParams, type ActionUnmuteParams as ActionUnmuteParams, };
}
