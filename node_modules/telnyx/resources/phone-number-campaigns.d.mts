...
export declare class PhoneNumberCampaigns extends APIResource {
    /**
     ...
     * ```
     */
    update(pathPhoneNumber: string, body: PhoneNumberCampaignUpdateParams, options?: RequestOptions): APIPromise<PhoneNumberCampaign>;
    /**
     ...
     * ```
     */
    list(query?: PhoneNumberCampaignListParams | null | undefined, options?: RequestOptions): APIPromise<PhoneNumberCampaignListResponse>;
    /**
...
export declare namespace PhoneNumberCampaignListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[telnyx_campaign_id], filter[telnyx_brand_id], filter[tcr_campaign_id],
     * filter[tcr_brand_id]
