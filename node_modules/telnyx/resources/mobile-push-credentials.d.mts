...
export declare class MobilePushCredentials extends APIResource {
    /**
     ...
     * ```
     */
    create(body: MobilePushCredentialCreateParams, options?: RequestOptions): APIPromise<PushCredentialResponse>;
    /**
     ...
     */
    list(query?: MobilePushCredentialListParams | null | undefined, options?: RequestOptions): APIPromise<MobilePushCredentialListResponse>;
    /**
...
export type MobilePushCredentialCreateParams = MobilePushCredentialCreateParams.CreateIosPushCredentialRequest | MobilePushCredentialCreateParams.CreateAndroidPushCredentialRequest;
export declare namespace MobilePushCredentialCreateParams {
    interface CreateIosPushCredentialRequest {
        /**
    ...
    interface CreateAndroidPushCredentialRequest {
        /**
         * Alias to uniquely identify the credential
         */
        alias: string;
...
export declare namespace MobilePushCredentialListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally: filter[type],
     * filter[alias]
     */
...
export declare namespace MobilePushCredentials {
    export { type PushCredential as PushCredential, type PushCredentialResponse as PushCredentialResponse, type MobilePushCredentialListResponse as MobilePushCredentialListResponse, type MobilePushCredentialCreateParams as MobilePushCredentialCreateParams, type MobilePushCredentialListParams as MobilePushCredentialListParams, };
}
//# sourceMappingURL=mobile-push-credentials.d.mts.map