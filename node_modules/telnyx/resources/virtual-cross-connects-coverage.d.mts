...
export declare class VirtualCrossConnectsCoverage extends APIResource {
    /**
     ...
     */
    list(query?: VirtualCrossConnectsCoverageListParams | null | undefined, options?: RequestOptions): APIPromise<VirtualCrossConnectsCoverageListResponse>;
}
...
export declare namespace VirtualCrossConnectsCoverageListResponse {
    interface Data {
        /**
...
export declare namespace VirtualCrossConnectsCoverageListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[cloud_provider], filter[cloud_provider_region], filter[location.region],
     * filter[location.site], filter[location.pop], filter[location.code]
...
export declare namespace VirtualCrossConnectsCoverage {
    export { type VirtualCrossConnectsCoverageListResponse as VirtualCrossConnectsCoverageListResponse, type VirtualCrossConnectsCoverageListParams as VirtualCrossConnectsCoverageListParams, };
}
//# sourceMappingURL=virtual-cross-connects-coverage.d.mts.map