...
export declare class MessagingOptouts extends APIResource {
    /**
     * Retrieve a list of opt-out blocks.
     */
    list(query?: MessagingOptoutListParams | null | undefined, options?: RequestOptions): APIPromise<MessagingOptoutListResponse>;
}
export interface MessagingOptoutListResponse {
    data?: Array<MessagingOptoutListResponse.Data>;
    meta?: AuthenticationProvidersAPI.PaginationMeta;
}
export declare namespace MessagingOptoutListResponse {
    interface Data {
        /**
...
export declare namespace MessagingOptoutListParams {
    /**
     * Consolidated created_at parameter (deepObject style). Originally:
     * created_at[gte], created_at[lte]
     */
...
export declare namespace MessagingOptouts {
    export { type MessagingOptoutListResponse as MessagingOptoutListResponse, type MessagingOptoutListParams as MessagingOptoutListParams, };
}
//# sourceMappingURL=messaging-optouts.d.mts.map