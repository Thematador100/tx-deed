...
export declare class Runs extends APIResource {
     ...
     * ```
     */
    list(testID: string, query?: RunListParams | null | undefined, options?: RequestOptions): APIPromise<TestSuitesRunsAPI.PaginatedTestRunList>;
    /**
...
export declare namespace TestRunResponse {
...
export declare namespace RunListParams {
    /**
     * Consolidated page parameter (deepObject style). Originally: page[size],
     * page[number]
     */
...
export declare namespace Runs {
    export { type TestRunResponse as TestRunResponse, type TestStatus as TestStatus, type RunRetrieveParams as RunRetrieveParams, type RunListParams as RunListParams, type RunTriggerParams as RunTriggerParams, };
}
