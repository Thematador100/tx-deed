...
export declare class CsvDownloads extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: CsvDownloadListParams | null | undefined, options?: RequestOptions): APIPromise<CsvDownloadListResponse>;
}
...
export declare namespace CsvDownloadCreateParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[has_bundle], filter[tag], filter[connection_id], filter[phone_number],
     * filter[status], filter[voice.connection_name],
...
export declare namespace CsvDownloadListParams {
    /**
     * Consolidated page parameter (deepObject style). Originally: page[size],
     * page[number]
     */
...
//# sourceMappingURL=csv-downloads.d.mts.map