...
import * as AccessIPAddressAPI from "./access-ip-address.js";
...
export declare class AccessIPRanges extends APIResource {
     ...
     */
    list(query?: AccessIPRangeListParams | null | undefined, options?: RequestOptions): APIPromise<AccessIPRangeListResponse>;
    /**
...
export declare namespace AccessIPRangeListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[cidr_block], filter[cidr_block][startswith],
     * filter[cidr_block][endswith], filter[cidr_block][contains], filter[created_at].
    ...
    namespace Filter {
         ...
         */
        interface CidrBlockPatternFilter {
            /**
...
export declare namespace AccessIPRanges {
    export { type AccessIPRange as AccessIPRange, type AccessIPRangeListResponse as AccessIPRangeListResponse, type AccessIPRangeCreateParams as AccessIPRangeCreateParams, type AccessIPRangeListParams as AccessIPRangeListParams, };
}
