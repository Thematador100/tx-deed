...
export declare class Runs extends APIResource {
     ...
     * ```
     */
    list(suiteName: string, query?: RunListParams | null | undefined, options?: RequestOptions): APIPromise<PaginatedTestRunList>;
    /**
...
export declare namespace Runs {
    export { type Meta as Meta, type PaginatedTestRunList as PaginatedTestRunList, type RunTriggerResponse as RunTriggerResponse, type RunListParams as RunListParams, type RunTriggerParams as RunTriggerParams, };
}
