...
import { ActionUploadFileParams, ActionUploadFileResponse, Actions } from "./actions.mjs";
import { APIPromise } from "../../core/api-promise.mjs";
import { RequestOptions } from "../../internal/request-options.mjs";
export declare class MessagingHostedNumberOrders extends APIResource {
     ...
     * ```
     */
    list(query?: MessagingHostedNumberOrderListParams | null | undefined, options?: RequestOptions): APIPromise<MessagingHostedNumberOrderListResponse>;
    /**
...
export declare namespace MessagingHostedNumberOrderCheckEligibilityResponse {
...
export interface MessagingHostedNumberOrderCreateVerificationCodesResponse {
    data: Array<MessagingHostedNumberOrderCreateVerificationCodesResponse.VerificationCodeSuccess | MessagingHostedNumberOrderCreateVerificationCodesResponse.VerificationCodeError>;
}
export declare namespace MessagingHostedNumberOrderCreateVerificationCodesResponse {
    /**
     ...
     */
    interface VerificationCodeError {
        /**
...
export declare namespace MessagingHostedNumberOrderValidateCodesResponse {
    interface Data {
        order_id: string;
...
export declare namespace MessagingHostedNumberOrderListParams {
    /**
     * Consolidated page parameter (deepObject style). Originally: page[number],
     * page[size]
     */
...
export declare namespace MessagingHostedNumberOrderValidateCodesParams {
