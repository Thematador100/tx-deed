...
class Conferences extends resource_1.APIResource {
    constructor() {
        super(...arguments);
    ...
    retrieve(id, query = {}, options) {
        return this._client.get((0, path_1.path) `/conferences/${id}`, { query, ...options });
    }
    /**
     ...
     * ```
     */
    listParticipants(conferenceID, query = {}, options) {
        return this._client.get((0, path_1.path) `/conferences/${conferenceID}/participants`, { query, ...options });
    }
}
exports.Conferences = Conferences;
Conferences.Actions = actions_1.Actions;
