...
import { ActionGenerateJoinClientTokenParams, ActionGenerateJoinClientTokenResponse, ActionRefreshClientTokenParams, ActionRefreshClientTokenResponse, Actions } from "./actions.mjs";
import * as SessionsAPI from "./sessions/sessions.mjs";
import { SessionList0Params, SessionList0Response, SessionList1Params, SessionList1Response, SessionRetrieveParams, SessionRetrieveParticipantsParams, SessionRetrieveParticipantsResponse, SessionRetrieveResponse, Sessions } from "./sessions/sessions.mjs";
...
export declare class Rooms extends APIResource {
     ...
     * ```
     */
    list(query?: RoomListParams | null | undefined, options?: RequestOptions): APIPromise<RoomListResponse>;
    /**
...
export declare namespace RoomListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[date_created_at][eq], filter[date_created_at][gte],
     * filter[date_created_at][lte], filter[date_updated_at][eq],
