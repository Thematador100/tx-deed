...
const RedeemableDeeds = () => {
  const [redeemableDeeds, setRedeemableDeeds] = useState([]);
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        ...
        <Tabs defaultValue="panel" className="w-full">
          ...
          <TabsContent value="panel">
            ...
            >
              {redeemableDeeds.length === 0 ? (
                <div className="col-span-full text-center py-16">
                  <Building className="w-16 h-16 mx-auto text-slate-300 mb-4" />
                  <h3 className="text-xl font-semibold text-slate-700 mb-2">No Redeemable Deeds Yet</h3>
                  <p className="text-slate-500">Import deeds to start tracking redemption periods.</p>
                </div>
              ) : redeemableDeeds.map((lead) => {
