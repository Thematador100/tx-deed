...
export declare class NumberOrderPhoneNumbers extends APIResource {
    /**
...
export declare namespace NumberOrderPhoneNumberUpdateRequirementGroupResponse {
    interface Data {
        id?: string;
...
export declare namespace NumberOrderPhoneNumberListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[country_code]
     */
