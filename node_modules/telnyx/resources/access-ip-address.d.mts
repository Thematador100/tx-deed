...
export declare class AccessIPAddress extends APIResource {
     ...
     */
    list(query?: AccessIPAddressListParams | null | undefined, options?: RequestOptions): APIPromise<AccessIPAddressListResponse>;
    /**
...
export declare namespace AccessIPAddressListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally: filter[ip_source],
     * filter[ip_address], filter[created_at]. Supports complex bracket operations for
     * dynamic filtering.
