"""
Anchorage County, Alaska Tax Deed/Lien Scraper
...
class AnchorageScraper(BaseScraper):
    """Scraper for Anchorage County, Alaska"""

    def __init__(self):
        super().__init__(
            county_name="Anchorage",
            state_code="AK",
            base_url="https://www.muni.org/treasury"
        )
