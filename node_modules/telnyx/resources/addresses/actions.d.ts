...
export declare class Actions extends APIResource {
     ...
     * ```
     */
    acceptSuggestions(pathID: string, body?: ActionAcceptSuggestionsParams | null | undefined, options?: RequestOptions): APIPromise<ActionAcceptSuggestionsResponse>;
    /**
...
export declare namespace ActionAcceptSuggestionsResponse {
    interface Data {
        /**
...
export declare namespace ActionValidateResponse {
    interface Data {
        /**
...
export declare namespace Actions {
    export { type ActionAcceptSuggestionsResponse as ActionAcceptSuggestionsResponse, type ActionValidateResponse as ActionValidateResponse, type ActionAcceptSuggestionsParams as ActionAcceptSuggestionsParams, type ActionValidateParams as ActionValidateParams, };
}
