...
export declare class NumberBlockOrders extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: NumberBlockOrderListParams | null | undefined, options?: RequestOptions): APIPromise<NumberBlockOrderListResponse>;
}
...
export declare namespace NumberBlockOrderListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally: filter[status],
     * filter[created_at], filter[phone_numbers.starting_number]
     */
