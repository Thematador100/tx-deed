"""
Franklin County, Ohio Tax Deed/Lien Scraper
...
class FranklinScraper(BaseScraper):
    """Scraper for Franklin County, Ohio"""

    def __init__(self):
        super().__init__(
            county_name="Franklin",
            state_code="OH",
            base_url="https://treasurer.franklincountyohio.gov"
        )
