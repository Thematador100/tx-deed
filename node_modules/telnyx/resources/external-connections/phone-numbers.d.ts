...
export declare class PhoneNumbers extends APIResource {
     ...
     * ```
     */
    list(id: string, query?: PhoneNumberListParams | null | undefined, options?: RequestOptions): APIPromise<PhoneNumberListResponse>;
}
