...
class Actions extends resource_1.APIResource {
     ...
     */
    retrieve(id, options) {
        return this._client.get((0, path_1.path) `/sim_card_group_actions/${id}`, options);
    }
    /**
     ...
     * ```
     */
    removePrivateWirelessGateway(id, options) {
        return this._client.post((0, path_1.path) `/sim_card_groups/${id}/actions/remove_private_wireless_gateway`, options);
    }
    /**
     ...
     * ```
     */
    removeWirelessBlocklist(id, options) {
        return this._client.post((0, path_1.path) `/sim_card_groups/${id}/actions/remove_wireless_blocklist`, options);
    }
    /**
     ...
     * ```
     */
    setPrivateWirelessGateway(id, body, options) {
        return this._client.post((0, path_1.path) `/sim_card_groups/${id}/actions/set_private_wireless_gateway`, {
            body,
            ...options,
        });
    }
     ...
     * ```
     */
    setWirelessBlocklist(id, body, options) {
        return this._client.post((0, path_1.path) `/sim_card_groups/${id}/actions/set_wireless_blocklist`, {
            body,
            ...options,
        });
    }
