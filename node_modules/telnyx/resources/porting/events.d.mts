...
export declare namespace EventRetrieveResponse {
    interface Data {
        /**
         ...
         */
        event_type?: 'porting_order.deleted' | 'porting_order.loa_updated' | 'porting_order.messaging_changed' | 'porting_order.status_changed' | 'porting_order.sharing_token_expired' | 'porting_order.new_comment' | 'porting_order.split';
        /**
         * The webhook payload for the porting_order.deleted event
         */
        payload?: Data.WebhookPortingOrderDeletedPayload | Data.WebhookPortingOrderMessagingChangedPayload | Data.WebhookPortingOrderStatusChangedPayload | Data.WebhookPortingOrderNewCommentPayload | Data.WebhookPortingOrderSplitPayload;
        /**
    ...
    namespace Data {
         ...
         * The webhook payload for the porting_order.deleted event
         */
        interface WebhookPortingOrderDeletedPayload {
            /**
         ...
         */
        interface WebhookPortingOrderMessagingChangedPayload {
            /**
        ...
        namespace WebhookPortingOrderMessagingChangedPayload {
            /**
             * The messaging portability status of the porting order.
             */
            interface Messaging {
         ...
         */
        interface WebhookPortingOrderStatusChangedPayload {
            /**
             * Identifies the porting order that was moved.
             */
            id?: string;
         ...
         */
        interface WebhookPortingOrderNewCommentPayload {
            /**
        ...
        namespace WebhookPortingOrderNewCommentPayload {
            /**
             * The comment that was added to the porting order.
             */
            interface Comment {
         ...
         */
        interface WebhookPortingOrderSplitPayload {
            /**
        ...
        namespace WebhookPortingOrderSplitPayload {
            /**
             * The porting order that was split.
             */
            interface From {
...
export declare namespace Events {
    export { type EventRetrieveResponse as EventRetrieveResponse, type EventListResponse as EventListResponse, type EventListParams as EventListParams, };
}
