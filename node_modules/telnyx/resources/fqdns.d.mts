...
export declare class Fqdns extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: FqdnListParams | null | undefined, options?: RequestOptions): APIPromise<FqdnListResponse>;
    /**
     * Delete an FQDN.
     *
     * @example
...
export declare namespace FqdnListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[connection_id], filter[fqdn], filter[port], filter[dns_record_type]
     */
...
export declare namespace Fqdns {
    export { type Fqdn as Fqdn, type FqdnCreateResponse as FqdnCreateResponse, type FqdnRetrieveResponse as FqdnRetrieveResponse, type FqdnUpdateResponse as FqdnUpdateResponse, type FqdnListResponse as FqdnListResponse, type FqdnDeleteResponse as FqdnDeleteResponse, type FqdnCreateParams as FqdnCreateParams, type FqdnUpdateParams as FqdnUpdateParams, type FqdnListParams as FqdnListParams, };
}
//# sourceMappingURL=fqdns.d.mts.map