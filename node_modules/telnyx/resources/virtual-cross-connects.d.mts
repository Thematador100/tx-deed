...
export declare class VirtualCrossConnects extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: VirtualCrossConnectListParams | null | undefined, options?: RequestOptions): APIPromise<VirtualCrossConnectListResponse>;
    /**
...
export declare namespace VirtualCrossConnectCreateResponse {
    interface Data extends GlobalIPAssignmentsAPI.Record, PublicInternetGatewaysAPI.Interface, PublicInternetGatewaysAPI.RegionIn {
        /**
...
export declare namespace VirtualCrossConnectListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally: filter[network_id]
     */
    interface Filter {
