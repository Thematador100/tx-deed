...
export declare class TelephonyCredentials extends APIResource {
    /**
     * Create a credential.
     *
     * @example
     ...
     * ```
     */
    list(query?: TelephonyCredentialListParams | null | undefined, options?: RequestOptions): APIPromise<TelephonyCredentialListResponse>;
    /**
...
export declare namespace TelephonyCredentialListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally: filter[tag],
     * filter[name], filter[status], filter[resource_id], filter[sip_username]
     */
