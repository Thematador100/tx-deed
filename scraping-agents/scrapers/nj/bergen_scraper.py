"""
Bergen County, New Jersey Tax Deed/Lien Scraper
...
class BergenScraper(BaseScraper):
    """Scraper for Bergen County, New Jersey"""

    def __init__(self):
        super().__init__(
            county_name="Bergen",
            state_code="NJ",
            base_url="https://www.co.bergen.nj.us/treasurer"
        )
        self.deed_type = "tax_lien"
