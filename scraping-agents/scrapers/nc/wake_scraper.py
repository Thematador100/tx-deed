"""
Wake County, North Carolina Tax Deed/Lien Scraper
...
class WakeScraper(BaseScraper):
    """Scraper for Wake County, North Carolina"""

    def __init__(self):
        super().__init__(
            county_name="Wake",
            state_code="NC",
            base_url="https://www.wake.gov/departments-government/tax-administration"
        )
