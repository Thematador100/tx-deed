...
export declare class UserAddresses extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: UserAddressListParams | null | undefined, options?: RequestOptions): APIPromise<UserAddressListResponse>;
}
...
export declare namespace UserAddressListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[customer_reference][eq], filter[customer_reference][contains],
     * filter[street_address][contains]
