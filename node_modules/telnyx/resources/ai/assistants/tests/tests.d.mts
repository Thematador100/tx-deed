...
import { RunListParams, RunRetrieveParams, RunTriggerParams, Runs, TestRunResponse, TestStatus } from "./runs.mjs";
import * as TestSuitesRunsAPI from "./test-suites/runs.mjs";
import * as TestSuitesAPI from "./test-suites/test-suites.mjs";
import { TestSuiteListResponse, TestSuites } from "./test-suites/test-suites.mjs";
import { APIPromise } from "../../../../core/api-promise.mjs";
import { RequestOptions } from "../../../../internal/request-options.mjs";
export declare class Tests extends APIResource {
    testSuites: TestSuitesAPI.TestSuites;
    runs: RunsAPI.Runs;
    /**
     ...
     * ```
     */
    list(query?: TestListParams | null | undefined, options?: RequestOptions): APIPromise<TestListResponse>;
    /**
...
export declare namespace AssistantTest {
    interface Rubric {
        /**
...
export declare namespace TestCreateParams {
    interface Rubric {
        /**
         * Specific guidance on how to assess the assistant’s performance for this rubric
         * item.
...
export declare namespace TestUpdateParams {
    interface Rubric {
        /**
         * Specific guidance on how to assess the assistant’s performance for this rubric
         * item.
...
export declare namespace TestListParams {
    /**
     * Consolidated page parameter (deepObject style). Originally: page[size],
     * page[number]
     */
...
export declare namespace Tests {
    export { type AssistantTest as AssistantTest, type TelnyxConversationChannel as TelnyxConversationChannel, type TestListResponse as TestListResponse, type TestDeleteResponse as TestDeleteResponse, type TestCreateParams as TestCreateParams, type TestUpdateParams as TestUpdateParams, type TestListParams as TestListParams, };
    export { TestSuites as TestSuites, type TestSuiteListResponse as TestSuiteListResponse };
    export { Runs as Runs, type TestRunResponse as TestRunResponse, type TestStatus as TestStatus, type RunRetrieveParams as RunRetrieveParams, type RunListParams as RunListParams, type RunTriggerParams as RunTriggerParams, };
}
