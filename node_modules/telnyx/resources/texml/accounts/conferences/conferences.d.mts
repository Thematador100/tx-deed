...
export declare namespace ConferenceRetrieveConferencesResponse {
...
export declare namespace ConferenceRetrieveRecordingsResponse {
    interface Recording {
        /**
         * The id of the account the resource belongs to.
         */
