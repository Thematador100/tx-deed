...
export declare class RoomParticipants extends APIResource {
    /**
     ...
     */
    list(query?: RoomParticipantListParams | null | undefined, options?: RequestOptions): APIPromise<RoomParticipantListResponse>;
}
...
export declare namespace RoomParticipantListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[date_joined_at][eq], filter[date_joined_at][gte],
     * filter[date_joined_at][lte], filter[date_updated_at][eq],
...
export declare namespace RoomParticipants {
    export { type RoomParticipantRetrieveResponse as RoomParticipantRetrieveResponse, type RoomParticipantListResponse as RoomParticipantListResponse, type RoomParticipantListParams as RoomParticipantListParams, };
}
//# sourceMappingURL=room-participants.d.ts.map