...
import { ActionExtendResponse, Actions } from "./actions.mjs";
import { APIPromise } from "../../core/api-promise.mjs";
import { RequestOptions } from "../../internal/request-options.mjs";
export declare class NumberReservations extends APIResource {
     ...
     * ```
     */
    list(query?: NumberReservationListParams | null | undefined, options?: RequestOptions): APIPromise<NumberReservationListResponse>;
}
...
export declare namespace NumberReservationListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally: filter[status],
     * filter[created_at], filter[phone_numbers.phone_number],
     * filter[customer_reference]
