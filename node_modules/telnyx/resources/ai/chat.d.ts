...
import * as AssistantsAPI from "./assistants/assistants.js";
...
export declare namespace ChatCreateCompletionParams {
    ...
    namespace ChatCompletionToolParam {
        interface Function {
            name: string;
            description?: string;
            parameters?: {
...
export declare namespace Chat {
    export { type BucketIDs as BucketIDs, type ChatCreateCompletionResponse as ChatCreateCompletionResponse, type ChatCreateCompletionParams as ChatCreateCompletionParams, };
}
