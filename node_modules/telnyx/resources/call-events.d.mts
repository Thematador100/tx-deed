...
export declare class CallEvents extends APIResource {
    /**
     ...
     */
    list(query?: CallEventListParams | null | undefined, options?: RequestOptions): APIPromise<CallEventListResponse>;
}
export interface CallEventListResponse {
    data?: Array<CallEventListResponse.Data>;
    meta?: AuthenticationProvidersAPI.PaginationMeta;
}
export declare namespace CallEventListResponse {
    interface Data {
        /**
...
export declare namespace CallEventListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[application_name][contains], filter[outbound.outbound_voice_profile_id],
     * filter[leg_id], filter[application_session_id], filter[connection_id],
...
export declare namespace CallEvents {
    export { type CallEventListResponse as CallEventListResponse, type CallEventListParams as CallEventListParams, };
}
//# sourceMappingURL=call-events.d.mts.map