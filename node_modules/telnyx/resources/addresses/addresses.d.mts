...
import { ActionAcceptSuggestionsParams, ActionAcceptSuggestionsResponse, ActionValidateParams, ActionValidateResponse, Actions } from "./actions.mjs";
...
export declare namespace AddressListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[customer_reference][eq], filter[customer_reference][contains],
     * filter[used_as_emergency], filter[street_address][contains],
...
export declare namespace Addresses {
    export { type Address as Address, type AddressCreateResponse as AddressCreateResponse, type AddressRetrieveResponse as AddressRetrieveResponse, type AddressListResponse as AddressListResponse, type AddressDeleteResponse as AddressDeleteResponse, type AddressCreateParams as AddressCreateParams, type AddressListParams as AddressListParams, };
    export { Actions as Actions, type ActionAcceptSuggestionsResponse as ActionAcceptSuggestionsResponse, type ActionValidateResponse as ActionValidateResponse, type ActionAcceptSuggestionsParams as ActionAcceptSuggestionsParams, type ActionValidateParams as ActionValidateParams, };
}
