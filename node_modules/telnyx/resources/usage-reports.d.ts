...
export declare namespace UsageReportListResponse {
    interface Meta {
        /**
...
export declare namespace UsageReportGetOptionsResponse {
    /**
     * An object following one of the schemas published in
     * https://developers.telnyx.com/docs/api/v2/detail-records
     */
...
export declare namespace UsageReportListParams {
    /**
...
export declare namespace UsageReports {
    export { type UsageReportListResponse as UsageReportListResponse, type UsageReportGetOptionsResponse as UsageReportGetOptionsResponse, type UsageReportListParams as UsageReportListParams, type UsageReportGetOptionsParams as UsageReportGetOptionsParams, };
}
