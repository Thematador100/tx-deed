...
import * as WireguardPeersAPI from "./wireguard-peers.js";
...
export declare class WireguardPeers extends APIResource {
     ...
     * ```
     */
    list(query?: WireguardPeerListParams | null | undefined, options?: RequestOptions): APIPromise<WireguardPeerListResponse>;
    /**
...
export declare namespace WireguardPeerCreateResponse {
    interface Data extends GlobalIPAssignmentsAPI.Record, WireguardPeersAPI.WireguardPeerPatch {
        /**
...
export declare namespace WireguardPeerRetrieveResponse {
    interface Data extends GlobalIPAssignmentsAPI.Record, WireguardPeersAPI.WireguardPeerPatch {
        /**
         * ISO 8601 formatted date-time indicating when peer sent traffic last time.
         */
...
export declare namespace WireguardPeerUpdateResponse {
    interface Data extends GlobalIPAssignmentsAPI.Record, WireguardPeersAPI.WireguardPeerPatch {
        /**
         * ISO 8601 formatted date-time indicating when peer sent traffic last time.
         */
...
export declare namespace WireguardPeerListResponse {
    interface Data extends GlobalIPAssignmentsAPI.Record, WireguardPeersAPI.WireguardPeerPatch {
        /**
         * ISO 8601 formatted date-time indicating when peer sent traffic last time.
         */
...
export declare namespace WireguardPeerDeleteResponse {
    interface Data extends GlobalIPAssignmentsAPI.Record, WireguardPeersAPI.WireguardPeerPatch {
        /**
         * ISO 8601 formatted date-time indicating when peer sent traffic last time.
         */
...
export declare namespace WireguardPeerListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[wireguard_interface_id]
     */
...
export declare namespace WireguardPeers {
    export { type WireguardPeerPatch as WireguardPeerPatch, type WireguardPeerCreateResponse as WireguardPeerCreateResponse, type WireguardPeerRetrieveResponse as WireguardPeerRetrieveResponse, type WireguardPeerUpdateResponse as WireguardPeerUpdateResponse, type WireguardPeerListResponse as WireguardPeerListResponse, type WireguardPeerDeleteResponse as WireguardPeerDeleteResponse, type WireguardPeerRetrieveConfigResponse as WireguardPeerRetrieveConfigResponse, type WireguardPeerCreateParams as WireguardPeerCreateParams, type WireguardPeerUpdateParams as WireguardPeerUpdateParams, type WireguardPeerListParams as WireguardPeerListParams, };
}
//# sourceMappingURL=wireguard-peers.d.ts.map