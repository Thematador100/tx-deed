...
import * as NumberOrderPhoneNumbersAPI from "./number-order-phone-numbers.mjs";
import { APIPromise } from "../core/api-promise.mjs";
import { RequestOptions } from "../internal/request-options.mjs";
export declare class SubNumberOrders extends APIResource {
    /**
...
export declare namespace SubNumberOrderUpdateRequirementGroupResponse {
    interface Data {
        id?: string;
        country_code?: string;
        created_at?: string;
...
export declare namespace SubNumberOrderRetrieveParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[include_phone_numbers]
     */
...
export declare namespace SubNumberOrderListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally: filter[status],
     * filter[order_request_id], filter[country_code], filter[phone_number_type],
     * filter[phone_numbers_count]
