...
const DealTicker = () => {
  // Sample deals to showcase the platform's potential
  const sampleDeals = [
    { sale_price: 331000, estimated_value: 900000 },
    { sale_price: 50000, estimated_value: 85000 },
    { sale_price: 322000, estimated_value: 410000 },
    { sale_price: 19000, estimated_value: 45000 },
    { sale_price: 278000, estimated_value: 350000 },
  ];
  const duplicatedDeals = [...sampleDeals, ...sampleDeals];
