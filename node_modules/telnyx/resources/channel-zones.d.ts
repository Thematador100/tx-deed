...
export declare class ChannelZones extends APIResource {
    /**
     ...
     * Channel Billing.
     */
    list(query?: ChannelZoneListParams | null | undefined, options?: RequestOptions): APIPromise<ChannelZoneListResponse>;
}
...
export declare namespace ChannelZoneListResponse {
    interface Data {
        id: string;
        channels: number;
        /**
...
export declare namespace ChannelZoneListParams {
    /**
     * Consolidated page parameter (deepObject style). Originally: page[size],
     * page[number]
     */
...
export declare namespace ChannelZones {
    export { type ChannelZoneUpdateResponse as ChannelZoneUpdateResponse, type ChannelZoneListResponse as ChannelZoneListResponse, type ChannelZoneUpdateParams as ChannelZoneUpdateParams, type ChannelZoneListParams as ChannelZoneListParams, };
}
//# sourceMappingURL=channel-zones.d.ts.map