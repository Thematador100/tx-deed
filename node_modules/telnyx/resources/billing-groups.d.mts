...
export declare class BillingGroups extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: BillingGroupListParams | null | undefined, options?: RequestOptions): APIPromise<BillingGroupListResponse>;
    /**
...
export declare namespace BillingGroupListParams {
    /**
     * Consolidated page parameter (deepObject style). Originally: page[number],
     * page[size]
     */
