"""
Snohomish County, Washington Tax Deed/Lien Scraper
...
class SnohomishScraper(BaseScraper):
    """Scraper for Snohomish County, Washington"""

    def __init__(self):
        super().__init__(
            county_name="Snohomish",
            state_code="WA",
            base_url="https://snohomishcountywa.gov/156/Treasurer"
        )
