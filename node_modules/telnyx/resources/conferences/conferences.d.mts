...
import { ActionHoldParams, ActionHoldResponse, ActionJoinParams, ActionJoinResponse, ActionLeaveParams, ActionLeaveResponse, ActionMuteParams, ActionMuteResponse, ActionPlayParams, ActionPlayResponse, ActionRecordPauseParams, ActionRecordPauseResponse, ActionRecordResumeParams, ActionRecordResumeResponse, ActionRecordStartParams, ActionRecordStartResponse, ActionRecordStopParams, ActionRecordStopResponse, ActionSpeakParams, ActionSpeakResponse, ActionStopParams, ActionStopResponse, ActionUnholdParams, ActionUnholdResponse, ActionUnmuteParams, ActionUnmuteResponse, ActionUpdateParams, ActionUpdateResponse, Actions, ConferenceCommandResult, UpdateConference } from "./actions.mjs";
import { APIPromise } from "../../core/api-promise.mjs";
import { RequestOptions } from "../../internal/request-options.mjs";
export declare class Conferences extends APIResource {
     ...
     * ```
     */
    list(query?: ConferenceListParams | null | undefined, options?: RequestOptions): APIPromise<ConferenceListResponse>;
    /**
     ...
     * ```
     */
    listParticipants(conferenceID: string, query?: ConferenceListParticipantsParams | null | undefined, options?: RequestOptions): APIPromise<ConferenceListParticipantsResponse>;
}
...
export declare namespace Conference {
    /**
     * IDs related to who ended the conference. It is expected for them to all be there
     * or all be null
     */
...
export declare namespace ConferenceListParticipantsResponse {
    interface Data {
        /**
...
export declare namespace ConferenceListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[application_name][contains], filter[outbound.outbound_voice_profile_id],
     * filter[leg_id], filter[application_session_id], filter[connection_id],
...
export declare namespace ConferenceListParticipantsParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally: filter[muted],
     * filter[on_hold], filter[whispering]
     */
...
export declare namespace Conferences {
    export { type Conference as Conference, type ConferenceCreateResponse as ConferenceCreateResponse, type ConferenceRetrieveResponse as ConferenceRetrieveResponse, type ConferenceListResponse as ConferenceListResponse, type ConferenceListParticipantsResponse as ConferenceListParticipantsResponse, type ConferenceCreateParams as ConferenceCreateParams, type ConferenceRetrieveParams as ConferenceRetrieveParams, type ConferenceListParams as ConferenceListParams, type ConferenceListParticipantsParams as ConferenceListParticipantsParams, };
    export { Actions as Actions, type ConferenceCommandResult as ConferenceCommandResult, type UpdateConference as UpdateConference, type ActionUpdateResponse as ActionUpdateResponse, type ActionHoldResponse as ActionHoldResponse, type ActionJoinResponse as ActionJoinResponse, type ActionLeaveResponse as ActionLeaveResponse, type ActionMuteResponse as ActionMuteResponse, type ActionPlayResponse as ActionPlayResponse, type ActionRecordPauseResponse as ActionRecordPauseResponse, type ActionRecordResumeResponse as ActionRecordResumeResponse, type ActionRecordStartResponse as ActionRecordStartResponse, type ActionRecordStopResponse as ActionRecordStopResponse, type ActionSpeakResponse as ActionSpeakResponse, type ActionStopResponse as ActionStopResponse, type ActionUnholdResponse as ActionUnholdResponse, type ActionUnmuteResponse as ActionUnmuteResponse, type ActionUpdateParams as ActionUpdateParams, type ActionHoldParams as ActionHoldParams, type ActionJoinParams as ActionJoinParams, type ActionLeaveParams as ActionLeaveParams, type ActionMuteParams as ActionMuteParams, type ActionPlayParams as ActionPlayParams, type ActionRecordPauseParams as ActionRecordPauseParams, type ActionRecordResumeParams as ActionRecordResumeParams, type ActionRecordStartParams as ActionRecordStartParams, type ActionRecordStopParams as ActionRecordStopParams, type ActionSpeakParams as ActionSpeakParams, type ActionStopParams as ActionStopParams, type ActionUnholdParams as ActionUnholdParams, type ActionUnmuteParams as ActionUnmuteParams, };
}
//# sourceMappingURL=conferences.d.mts.map