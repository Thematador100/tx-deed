...
exports.MdrUsageReports = void 0;
const resource_1 = require("../../core/resource.js");
const headers_1 = require("../../internal/headers.js");
const path_1 = require("../../internal/utils/path.js");
class MdrUsageReports extends resource_1.APIResource {
    /**
    ...
    create(body, options) {
        return this._client.post('/reports/mdr_usage_reports', {
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([{ 'Content-Type': '*/*' }, options?.headers]),
        });
    }
    /**
     ...
     */
    retrieve(id, options) {
        return this._client.get((0, path_1.path) `/reports/mdr_usage_reports/${id}`, options);
    }
    /**
     ...
     */
    delete(id, options) {
        return this._client.delete((0, path_1.path) `/reports/mdr_usage_reports/${id}`, options);
    }
    /**
     ...
     * ```
     */
    fetchSync(query, options) {
        return this._client.get('/reports/mdr_usage_reports/sync', { query, ...options });
    }
}
exports.MdrUsageReports = MdrUsageReports;
//# sourceMappingURL=mdr-usage-reports.js.map