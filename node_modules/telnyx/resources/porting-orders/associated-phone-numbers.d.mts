...
export declare class AssociatedPhoneNumbers extends APIResource {
    /**
     ...
     * ```
     */
    list(portingOrderID: string, query?: AssociatedPhoneNumberListParams | null | undefined, options?: RequestOptions): APIPromise<AssociatedPhoneNumberListResponse>;
    /**
...
export declare namespace PortingAssociatedPhoneNumber {
    /**
     * Specifies the phone number range for this associated phone number.
     */
    interface PhoneNumberRange {
        /**
...
export declare namespace AssociatedPhoneNumberCreateParams {
    interface PhoneNumberRange {
        /**
         * Specifies the end of the phone number range for this associated phone number.
         */
...
export declare namespace AssociatedPhoneNumberListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[phone_number], filter[action]
     */
...
export declare namespace AssociatedPhoneNumbers {
    export { type PortingAssociatedPhoneNumber as PortingAssociatedPhoneNumber, type AssociatedPhoneNumberCreateResponse as AssociatedPhoneNumberCreateResponse, type AssociatedPhoneNumberListResponse as AssociatedPhoneNumberListResponse, type AssociatedPhoneNumberDeleteResponse as AssociatedPhoneNumberDeleteResponse, type AssociatedPhoneNumberCreateParams as AssociatedPhoneNumberCreateParams, type AssociatedPhoneNumberListParams as AssociatedPhoneNumberListParams, type AssociatedPhoneNumberDeleteParams as AssociatedPhoneNumberDeleteParams, };
}
//# sourceMappingURL=associated-phone-numbers.d.mts.map