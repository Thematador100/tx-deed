"""
Pierce County, Washington Tax Deed/Lien Scraper
...
class PierceScraper(BaseScraper):
    """Scraper for Pierce County, Washington"""

    def __init__(self):
        super().__init__(
            county_name="Pierce",
            state_code="WA",
            base_url="https://www.piercecountywa.gov/treasurer"
        )
