...
export declare class ShortCodes extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: ShortCodeListParams | null | undefined, options?: RequestOptions): APIPromise<ShortCodeListResponse>;
}
...
export declare namespace ShortCodeListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[messaging_profile_id]
     */
...
export declare namespace ShortCodes {
    export { type ShortCodeRetrieveResponse as ShortCodeRetrieveResponse, type ShortCodeUpdateResponse as ShortCodeUpdateResponse, type ShortCodeListResponse as ShortCodeListResponse, type ShortCodeUpdateParams as ShortCodeUpdateParams, type ShortCodeListParams as ShortCodeListParams, };
}
//# sourceMappingURL=short-codes.d.mts.map