...
import { InsightCreateParams, InsightDeleteResponse, InsightListParams, InsightListResponse, InsightTemplate, InsightTemplateDetail, InsightUpdateParams, Insights } from "./insights.mjs";
import * as MessagesAPI from "./messages.mjs";
import { MessageListResponse, Messages } from "./messages.mjs";
import * as InsightGroupsAPI from "./insight-groups/insight-groups.mjs";
import { InsightGroupDeleteResponse, InsightGroupInsightGroupsParams, InsightGroupRetrieveInsightGroupsParams, InsightGroupRetrieveInsightGroupsResponse, InsightGroupUpdateParams, InsightGroups, InsightTemplateGroup, InsightTemplateGroupDetail } from "./insight-groups/insight-groups.mjs";
import * as RunsAPI from "../assistants/tests/test-suites/runs.mjs";
import { APIPromise } from "../../../core/api-promise.mjs";
import { RequestOptions } from "../../../internal/request-options.mjs";
export declare class Conversations extends APIResource {
    insightGroups: InsightGroupsAPI.InsightGroups;
     ...
     * ```
     */
    addMessage(conversationID: string, body: ConversationAddMessageParams, options?: RequestOptions): APIPromise<unknown>;
    /**
...
export declare namespace ConversationRetrieveConversationsInsightsResponse {
    interface Data {
        /**
...
export declare namespace Conversations {
    ...
    export { InsightGroups as InsightGroups, type InsightTemplateGroup as InsightTemplateGroup, type InsightTemplateGroupDetail as InsightTemplateGroupDetail, type InsightGroupDeleteResponse as InsightGroupDeleteResponse, type InsightGroupRetrieveInsightGroupsResponse as InsightGroupRetrieveInsightGroupsResponse, type InsightGroupUpdateParams as InsightGroupUpdateParams, type InsightGroupInsightGroupsParams as InsightGroupInsightGroupsParams, type InsightGroupRetrieveInsightGroupsParams as InsightGroupRetrieveInsightGroupsParams, };
    export { Insights as Insights, type InsightTemplate as InsightTemplate, type InsightTemplateDetail as InsightTemplateDetail, type InsightListResponse as InsightListResponse, type InsightDeleteResponse as InsightDeleteResponse, type InsightCreateParams as InsightCreateParams, type InsightUpdateParams as InsightUpdateParams, type InsightListParams as InsightListParams, };
