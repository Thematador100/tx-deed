...
export declare class FaxApplications extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: FaxApplicationListParams | null | undefined, options?: RequestOptions): APIPromise<FaxApplicationListResponse>;
    /**
...
export declare namespace FaxApplication {
    interface Inbound {
        /**
...
export declare namespace FaxApplicationCreateParams {
    interface Inbound {
        /**
         * When set, this will limit the number of concurrent inbound calls to phone
         * numbers associated with this connection.
...
export declare namespace FaxApplicationUpdateParams {
    interface Inbound {
        /**
         * When set, this will limit the number of concurrent inbound calls to phone
         * numbers associated with this connection.
...
export declare namespace FaxApplicationListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[application_name][contains], filter[outbound_voice_profile_id]
     */
