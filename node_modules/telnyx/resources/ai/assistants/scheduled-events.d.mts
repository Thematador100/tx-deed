...
import * as RunsAPI from "./tests/test-suites/runs.mjs";
import { APIPromise } from "../../../core/api-promise.mjs";
import { RequestOptions } from "../../../internal/request-options.mjs";
export declare class ScheduledEvents extends APIResource {
    /**
     ...
     * ```
     */
    list(assistantID: string, query?: ScheduledEventListParams | null | undefined, options?: RequestOptions): APIPromise<ScheduledEventListResponse>;
    /**
...
export declare namespace ScheduledEventListParams {
    /**
     * Consolidated page parameter (deepObject style). Originally: page[size],
     * page[number]
     */
