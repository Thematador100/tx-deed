...
import { ActionBulkSetPublicIPsParams, ActionBulkSetPublicIPsResponse, ActionDisableResponse, ActionEnableResponse, ActionListParams, ActionListResponse, ActionRemovePublicIPResponse, ActionRetrieveResponse, ActionSetPublicIPParams, ActionSetPublicIPResponse, ActionSetStandbyResponse, ActionValidateRegistrationCodesParams, ActionValidateRegistrationCodesResponse, Actions, SimCardAction } from "./actions.mjs";
import { APIPromise } from "../../core/api-promise.mjs";
import { RequestOptions } from "../../internal/request-options.mjs";
export declare class SimCards extends APIResource {
     ...
     * ```
     */
    list(query?: SimCardListParams | null | undefined, options?: RequestOptions): APIPromise<SimCardListResponse>;
    /**
     ...
     * ```
     */
    listWirelessConnectivityLogs(id: string, query?: SimCardListWirelessConnectivityLogsParams | null | undefined, options?: RequestOptions): APIPromise<SimCardListWirelessConnectivityLogsResponse>;
}
...
export declare namespace SimCard {
    /**
     * The SIM card consumption so far in the current billing cycle.
     */
    interface CurrentBillingPeriodConsumedData {
        amount?: string;
        unit?: string;
    }
    /**
...
export declare namespace SimCardGetActivationCodeResponse {
    interface Data {
        /**
...
export declare namespace SimCardGetDeviceDetailsResponse {
    interface Data {
        /**
...
export declare namespace SimCardGetPublicIPResponse {
    interface Data {
        /**
         * ISO 8601 formatted date-time indicating when the resource was created.
         */
...
export declare namespace SimCardListWirelessConnectivityLogsResponse {
    /**
...
export declare namespace SimCardUpdateParams {
    /**
     * The SIM card individual data limit configuration.
     */
    interface DataLimit {
...
export declare namespace SimCardListParams {
    /**
     * Consolidated filter parameter for SIM cards (deepObject style). Originally:
     * filter[tags], filter[iccid], filter[status]
     */
...
export declare namespace SimCards {
    ...
    export { Actions as Actions, type SimCardAction as SimCardAction, type ActionRetrieveResponse as ActionRetrieveResponse, type ActionListResponse as ActionListResponse, type ActionBulkSetPublicIPsResponse as ActionBulkSetPublicIPsResponse, type ActionDisableResponse as ActionDisableResponse, type ActionEnableResponse as ActionEnableResponse, type ActionRemovePublicIPResponse as ActionRemovePublicIPResponse, type ActionSetPublicIPResponse as ActionSetPublicIPResponse, type ActionSetStandbyResponse as ActionSetStandbyResponse, type ActionValidateRegistrationCodesResponse as ActionValidateRegistrationCodesResponse, type ActionListParams as ActionListParams, type ActionBulkSetPublicIPsParams as ActionBulkSetPublicIPsParams, type ActionSetPublicIPParams as ActionSetPublicIPParams, type ActionValidateRegistrationCodesParams as ActionValidateRegistrationCodesParams, };
}
//# sourceMappingURL=sim-cards.d.mts.map