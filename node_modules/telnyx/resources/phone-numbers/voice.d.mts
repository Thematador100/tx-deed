...
export declare class Voice extends APIResource {
     ...
     * ```
     */
    list(query?: VoiceListParams | null | undefined, options?: RequestOptions): APIPromise<VoiceListResponse>;
}
/**
...
export declare namespace VoiceListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[phone_number], filter[connection_name], filter[customer_reference],
     * filter[voice.usage_payment_method]
...
export declare namespace Voice {
    export { type CallForwarding as CallForwarding, type CallRecording as CallRecording, type CnamListing as CnamListing, type MediaFeatures as MediaFeatures, type UpdateVoiceSettings as UpdateVoiceSettings, type VoiceRetrieveResponse as VoiceRetrieveResponse, type VoiceUpdateResponse as VoiceUpdateResponse, type VoiceListResponse as VoiceListResponse, type VoiceUpdateParams as VoiceUpdateParams, type VoiceListParams as VoiceListParams, };
}
