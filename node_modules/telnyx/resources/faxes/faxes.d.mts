...
import { ActionCancelResponse, ActionRefreshResponse, Actions } from "./actions.mjs";
import { APIPromise } from "../../core/api-promise.mjs";
import { RequestOptions } from "../../internal/request-options.mjs";
export declare class Faxes extends APIResource {
...
export declare namespace FaxListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[created_at][gte], filter[created_at][gt], filter[created_at][lte],
     * filter[created_at][lt], filter[direction][eq], filter[from][eq], filter[to][eq]
...
export declare namespace Faxes {
    export { type Fax as Fax, type FaxCreateResponse as FaxCreateResponse, type FaxRetrieveResponse as FaxRetrieveResponse, type FaxListResponse as FaxListResponse, type FaxCreateParams as FaxCreateParams, type FaxListParams as FaxListParams, };
