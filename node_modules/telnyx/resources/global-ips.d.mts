...
export declare class GlobalIPs extends APIResource {
     ...
     * ```
     */
    list(query?: GlobalIPListParams | null | undefined, options?: RequestOptions): APIPromise<GlobalIPListResponse>;
    /**
     * Delete a Global IP.
     *
     * @example
...
export declare namespace GlobalIPCreateResponse {
...
export declare namespace GlobalIPRetrieveResponse {
    interface Data extends GlobalIPAssignmentsAPI.Record {
        /**
         * A user specified description for the address.
         */
...
export declare namespace GlobalIPListResponse {
    interface Data extends GlobalIPAssignmentsAPI.Record {
        /**
         * A user specified description for the address.
         */
...
export declare namespace GlobalIPDeleteResponse {
    interface Data extends GlobalIPAssignmentsAPI.Record {
        /**
         * A user specified description for the address.
         */
...
export declare namespace GlobalIPListParams {
    /**
     * Consolidated page parameter (deepObject style). Originally: page[number],
     * page[size]
     */
