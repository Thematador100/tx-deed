...
export declare class Requirements extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: RequirementListParams | null | undefined, options?: RequestOptions): APIPromise<RequirementListResponse>;
}
export interface RequirementRetrieveResponse {
    data?: RequirementRetrieveResponse.Data;
}
export declare namespace RequirementRetrieveResponse {
    interface Data {
        /**
...
export declare namespace RequirementListResponse {
    interface Data {
        /**
         * Identifies the associated document
         */
...
export declare namespace Requirements {
    export { type RequirementRetrieveResponse as RequirementRetrieveResponse, type RequirementListResponse as RequirementListResponse, type RequirementListParams as RequirementListParams, };
}
