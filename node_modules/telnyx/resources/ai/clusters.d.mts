...
import * as PhoneNumberAssignmentByProfileAPI from "../phone-number-assignment-by-profile.mjs";
...
export declare class Clusters extends APIResource {
     ...
     * ```
     */
    list(query?: ClusterListParams | null | undefined, options?: RequestOptions): APIPromise<ClusterListResponse>;
    /**
     * Delete a cluster
     *
     * @example
     ...
     * ```
     */
    fetchGraph(taskID: string, query?: ClusterFetchGraphParams | null | undefined, options?: RequestOptions): APIPromise<unknown>;
}
...
export declare namespace RecursiveCluster {
    interface Node {
        /**
...
export declare namespace ClusterRetrieveResponse {
    interface Data {
        bucket: string;
...
export declare namespace ClusterListResponse {
    interface Data {
        bucket: string;
        created_at: string;
        finished_at: string;
...
export declare namespace ClusterComputeResponse {
    interface Data {
        task_id: string;
    }
}
...
export declare namespace ClusterListParams {
    /**
     * Consolidated page parameter (deepObject style). Originally: page[number],
     * page[size]
     */
