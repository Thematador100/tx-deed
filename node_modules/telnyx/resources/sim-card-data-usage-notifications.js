...
exports.SimCardDataUsageNotifications = void 0;
const resource_1 = require("../core/resource.js");
const path_1 = require("../internal/utils/path.js");
class SimCardDataUsageNotifications extends resource_1.APIResource {
    /**
     ...
     */
    retrieve(id, options) {
        return this._client.get((0, path_1.path) `/sim_card_data_usage_notifications/${id}`, options);
    }
    /**
    ...
    update(id, body, options) {
        return this._client.patch((0, path_1.path) `/sim_card_data_usage_notifications/${id}`, { body, ...options });
    }
    /**
     ...
     */
    delete(id, options) {
        return this._client.delete((0, path_1.path) `/sim_card_data_usage_notifications/${id}`, options);
    }
}
exports.SimCardDataUsageNotifications = SimCardDataUsageNotifications;
//# sourceMappingURL=sim-card-data-usage-notifications.js.map