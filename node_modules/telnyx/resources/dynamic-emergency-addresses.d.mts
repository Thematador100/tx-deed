...
export declare class DynamicEmergencyAddresses extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: DynamicEmergencyAddressListParams | null | undefined, options?: RequestOptions): APIPromise<DynamicEmergencyAddressListResponse>;
    /**
...
export declare namespace DynamicEmergencyAddressListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally: filter[status],
     * filter[country_code]
     */
...
export declare namespace DynamicEmergencyAddresses {
    export { type DynamicEmergencyAddress as DynamicEmergencyAddress, type DynamicEmergencyAddressCreateResponse as DynamicEmergencyAddressCreateResponse, type DynamicEmergencyAddressRetrieveResponse as DynamicEmergencyAddressRetrieveResponse, type DynamicEmergencyAddressListResponse as DynamicEmergencyAddressListResponse, type DynamicEmergencyAddressDeleteResponse as DynamicEmergencyAddressDeleteResponse, type DynamicEmergencyAddressCreateParams as DynamicEmergencyAddressCreateParams, type DynamicEmergencyAddressListParams as DynamicEmergencyAddressListParams, };
}
//# sourceMappingURL=dynamic-emergency-addresses.d.mts.map