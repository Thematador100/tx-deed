...
export declare class DynamicEmergencyEndpoints extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: DynamicEmergencyEndpointListParams | null | undefined, options?: RequestOptions): APIPromise<DynamicEmergencyEndpointListResponse>;
    /**
...
export declare namespace DynamicEmergencyEndpointListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally: filter[status],
     * filter[country_code]
     */
