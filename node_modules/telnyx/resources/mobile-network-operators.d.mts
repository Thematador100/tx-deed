...
export declare class MobileNetworkOperators extends APIResource {
    /**
     ...
     */
    list(query?: MobileNetworkOperatorListParams | null | undefined, options?: RequestOptions): APIPromise<MobileNetworkOperatorListResponse>;
}
export interface MobileNetworkOperatorListResponse {
    data?: Array<MobileNetworkOperatorListResponse.Data>;
    meta?: AuthenticationProvidersAPI.PaginationMeta;
}
export declare namespace MobileNetworkOperatorListResponse {
    interface Data {
        /**
...
export declare namespace MobileNetworkOperatorListParams {
    /**
     * Consolidated filter parameter for mobile network operators (deepObject style).
     * Originally: filter[name][starts_with], filter[name][contains],
     * filter[name][ends_with], filter[country_code], filter[mcc], filter[mnc],
...
export declare namespace MobileNetworkOperators {
    export { type MobileNetworkOperatorListResponse as MobileNetworkOperatorListResponse, type MobileNetworkOperatorListParams as MobileNetworkOperatorListParams, };
}
//# sourceMappingURL=mobile-network-operators.d.mts.map