...
export declare class GlobalIPHealthChecks extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: GlobalIPHealthCheckListParams | null | undefined, options?: RequestOptions): APIPromise<GlobalIPHealthCheckListResponse>;
    /**
...
export declare namespace GlobalIPHealthCheckListResponse {
    interface Data extends GlobalIPAssignmentsAPI.Record {
        /**
         * Global IP ID.
         */
...
export declare namespace GlobalIPHealthCheckDeleteResponse {
    interface Data extends GlobalIPAssignmentsAPI.Record {
        /**
         * Global IP ID.
         */
...
export declare namespace GlobalIPHealthCheckListParams {
    /**
     * Consolidated page parameter (deepObject style). Originally: page[number],
     * page[size]
     */
