...
import { CanaryDeploy, CanaryDeployCreateParams, CanaryDeployResponse, CanaryDeployUpdateParams, CanaryDeploys, VersionConfig } from "./canary-deploys.mjs";
import * as ScheduledEventsAPI from "./scheduled-events.mjs";
import { ConversationChannelType, EventStatus, ScheduledEventCreateParams, ScheduledEventDeleteParams, ScheduledEventDeleteResponse, ScheduledEventListParams, ScheduledEventListResponse, ScheduledEventResponse, ScheduledEventRetrieveParams, ScheduledEvents, ScheduledPhoneCallEventResponse, ScheduledSMSEventResponse } from "./scheduled-events.mjs";
import * as ToolsAPI from "./tools.mjs";
import { ToolTestParams, ToolTestResponse, Tools } from "./tools.mjs";
import * as VersionsAPI from "./versions.mjs";
import { UpdateAssistant, VersionDeleteParams, VersionPromoteParams, VersionRetrieveParams, VersionUpdateParams, Versions } from "./versions.mjs";
import * as TestsAPI from "./tests/tests.mjs";
import { AssistantTest, TelnyxConversationChannel, TestCreateParams, TestDeleteResponse, TestListParams, TestListResponse, TestUpdateParams, Tests } from "./tests/tests.mjs";
import { APIPromise } from "../../../core/api-promise.mjs";
import { RequestOptions } from "../../../internal/request-options.mjs";
export declare class Assistants extends APIResource {
    tests: TestsAPI.Tests;
    canaryDeploys: CanaryDeploysAPI.CanaryDeploys;
    scheduledEvents: ScheduledEventsAPI.ScheduledEvents;
...
export interface Assistant {
     ...
     */
    tools?: Array<Assistant.BookAppointmentTool | Assistant.CheckAvailabilityTool | WebhookTool | HangupTool | TransferTool | RetrievalTool>;
}
export declare namespace Assistant {
    interface BookAppointmentTool {
        book_appointment: BookAppointmentTool.BookAppointment;
        type: 'book_appointment';
    }
    namespace BookAppointmentTool {
    ...
    namespace CheckAvailabilityTool {
 ...
 * user.
 */
export type AssistantTool = WebhookTool | RetrievalTool | AssistantTool.HandoffTool | HangupTool | TransferTool | AssistantTool.SipReferTool | AssistantTool.DtmfTool;
export declare namespace AssistantTool {
    /**
     * The handoff tool allows the assistant to hand off control of the conversation to
     * another AI assistant. By default, this will happen transparently to the end
     * user.
    ...
    interface SipReferTool {
        refer: SipReferTool.Refer;
        type: 'refer';
    }
    namespace SipReferTool {
        interface Refer {
            /**
...
export declare namespace InferenceEmbeddingTransferToolParams {
    interface Target {
        /**
         * The name of the target.
         */
...
export declare namespace InferenceEmbeddingWebhookToolParams {
    /**
     * The body parameters the webhook tool accepts, described as a JSON Schema object.
     * These parameters will be passed to the webhook as the body of the request. See
     * the [JSON Schema reference](https://json-schema.org/understanding-json-schema)
...
export declare namespace Assistants {
    ...
    export { Tests as Tests, type AssistantTest as AssistantTest, type TelnyxConversationChannel as TelnyxConversationChannel, type TestListResponse as TestListResponse, type TestDeleteResponse as TestDeleteResponse, type TestCreateParams as TestCreateParams, type TestUpdateParams as TestUpdateParams, type TestListParams as TestListParams, };
