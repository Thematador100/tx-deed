"""
Greenville County, South Carolina Tax Deed/Lien Scraper
...
class GreenvilleScraper(BaseScraper):
    """Scraper for Greenville County, South Carolina"""

    def __init__(self):
        super().__init__(
            county_name="Greenville",
            state_code="SC",
            base_url="https://www.greenvillecounty.org/TaxCollection"
        )
