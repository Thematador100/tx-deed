import React, { useState, useEffect, useCallback } from 'react';
    ...
    import { Bot, Cpu, BookUser, Shield, FileInput, Loader2, Clock, BarChart3, TrendingUp, Activity } from 'lucide-react';
    ...
    const AdminAIWorkforce = () => {
      ...
      return (
        <AdminLayout>
          ...
          >
            <div>
                <h1 className="text-3xl font-bold text-slate-900 mb-2">AI Workforce Management</h1>
                <p className="text-slate-600 mb-4">
                  Real-time monitor for your multi-agent system with scheduling, quotas, and performance metrics.
                </p>
            </div>
              ...
              <TabsContent value="metrics" className="space-y-6 mt-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Detailed metrics will be available after agents run</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p className="text-sm text-slate-600 text-center py-8">
                      Run agents to generate performance data and insights.
                    </p>
                  </CardContent>
                </Card>
              </TabsContent>
