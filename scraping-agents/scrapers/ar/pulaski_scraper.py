"""
Pulaski County, Arkansas Tax Deed/Lien Scraper
...
class PulaskiScraper(BaseScraper):
    """Scraper for Pulaski County, Arkansas"""

    def __init__(self):
        super().__init__(
            county_name="Pulaski",
            state_code="AR",
            base_url="https://www.pulaskicounty.net/treasurer"
        )
        self.deed_type = "redeemable_deed"
