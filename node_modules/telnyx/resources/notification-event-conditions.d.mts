...
export declare class NotificationEventConditions extends APIResource {
    /**
     * Returns a list of your notifications events conditions.
     */
    list(query?: NotificationEventConditionListParams | null | undefined, options?: RequestOptions): APIPromise<NotificationEventConditionListResponse>;
}
export interface NotificationEventConditionListResponse {
    data?: Array<NotificationEventConditionListResponse.Data>;
    meta?: AuthenticationProvidersAPI.PaginationMeta;
}
export declare namespace NotificationEventConditionListResponse {
    interface Data {
        /**
         * A UUID.
         */
...
export declare namespace NotificationEventConditionListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[associated_record_type][eq], filter[channel_type_id][eq],
     * filter[notification_profile_id][eq], filter[notification_channel][eq],
...
export declare namespace NotificationEventConditions {
    export { type NotificationEventConditionListResponse as NotificationEventConditionListResponse, type NotificationEventConditionListParams as NotificationEventConditionListParams, };
}
//# sourceMappingURL=notification-event-conditions.d.mts.map