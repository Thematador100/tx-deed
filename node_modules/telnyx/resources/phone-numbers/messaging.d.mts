...
export declare class Messaging extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: MessagingListParams | null | undefined, options?: RequestOptions): APIPromise<MessagingListResponse>;
}
...
export declare namespace MessagingListParams {
    /**
     * Consolidated page parameter (deepObject style). Originally: page[number],
     * page[size]
     */
...
export declare namespace Messaging {
    export { type MessagingRetrieveResponse as MessagingRetrieveResponse, type MessagingUpdateResponse as MessagingUpdateResponse, type MessagingListResponse as MessagingListResponse, type MessagingUpdateParams as MessagingUpdateParams, type MessagingListParams as MessagingListParams, };
}
