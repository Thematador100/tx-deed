...
export declare namespace EventRetrieveResponse {
    interface Data {
         ...
         */
        payload?: Data.WebhookPortoutStatusChangedPayload | Data.WebhookPortoutNewCommentPayload | Data.WebhookPortoutFocDateChangedPayload;
        /**
    ...
    namespace Data {
         ...
         * The webhook payload for the portout.status_changed event
         */
        interface WebhookPortoutStatusChangedPayload {
            /**
         ...
         */
        interface WebhookPortoutNewCommentPayload {
            /**
         ...
         */
        interface WebhookPortoutFocDateChangedPayload {
            /**
