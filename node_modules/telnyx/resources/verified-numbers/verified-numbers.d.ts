...
import { ActionSubmitVerificationCodeParams, Actions } from "./actions.js";
import { APIPromise } from "../../core/api-promise.js";
import { RequestOptions } from "../../internal/request-options.js";
export declare class VerifiedNumbers extends APIResource {
     ...
     * ```
     */
    list(query?: VerifiedNumberListParams | null | undefined, options?: RequestOptions): APIPromise<VerifiedNumberListResponse>;
    /**
...
export declare namespace VerifiedNumberListResponse {
    interface Meta {
        page_number?: number;
        page_size?: number;
        total_pages?: number;
...
export declare namespace VerifiedNumberListParams {
    /**
     * Consolidated page parameter (deepObject style). Use page[size] and page[number]
     * in the query string. Originally: page[size], page[number]
     */
