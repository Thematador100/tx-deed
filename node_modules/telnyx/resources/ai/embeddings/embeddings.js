...
const BucketsAPI = tslib_1.__importStar(require("./buckets.js"));
const buckets_1 = require("./buckets.js");
...
class Embeddings extends resource_1.APIResource {
    ...
    retrieve(taskID, options) {
        return this._client.get((0, path_1.path) `/ai/embeddings/${taskID}`, options);
    }
    /**
...
Embeddings.Buckets = buckets_1.Buckets;
