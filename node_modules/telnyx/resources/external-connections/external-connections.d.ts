...
import * as CivicAddressesAPI from "./civic-addresses.js";
import { CivicAddressListParams, CivicAddressListResponse, CivicAddressRetrieveParams, CivicAddressRetrieveResponse, CivicAddresses } from "./civic-addresses.js";
import * as LogMessagesAPI from "./log-messages.js";
import { LogMessageDismissResponse, LogMessageListParams, LogMessageListResponse, LogMessageRetrieveResponse, LogMessages } from "./log-messages.js";
import * as PhoneNumbersAPI from "./phone-numbers.js";
import { ExternalConnectionPhoneNumber, PhoneNumberListParams, PhoneNumberListResponse, PhoneNumberRetrieveParams, PhoneNumberRetrieveResponse, PhoneNumberUpdateParams, PhoneNumberUpdateResponse, PhoneNumbers } from "./phone-numbers.js";
import * as ReleasesAPI from "./releases.js";
import { ReleaseListParams, ReleaseListResponse, ReleaseRetrieveParams, ReleaseRetrieveResponse, Releases } from "./releases.js";
import * as UploadsAPI from "./uploads.js";
import { TnUploadEntry, Upload, UploadCreateParams, UploadCreateResponse, UploadListParams, UploadListResponse, UploadPendingCountResponse, UploadRefreshStatusResponse, UploadRetrieveParams, UploadRetrieveResponse, UploadRetryParams, UploadRetryResponse, Uploads } from "./uploads.js";
import { APIPromise } from "../../core/api-promise.js";
import { RequestOptions } from "../../internal/request-options.js";
export declare class ExternalConnections extends APIResource {
    logMessages: LogMessagesAPI.LogMessages;
    civicAddresses: CivicAddressesAPI.CivicAddresses;
     ...
     * ```
     */
    list(query?: ExternalConnectionListParams | null | undefined, options?: RequestOptions): APIPromise<ExternalConnectionListResponse>;
    /**
...
export declare namespace ExternalConnection {
    interface Inbound {
        /**
...
export declare namespace ExternalConnectionUpdateLocationResponse {
    interface Data {
...
export declare namespace ExternalConnectionCreateParams {
    interface Outbound {
        /**
         * When set, this will limit the number of concurrent outbound calls to phone
         * numbers associated with this connection.
...
export declare namespace ExternalConnectionUpdateParams {
    interface Outbound {
        /**
         * Identifies the associated outbound voice profile.
         */
...
export declare namespace ExternalConnectionListParams {
    /**
     * Filter parameter for external connections (deepObject style). Supports filtering
     * by connection_name, external_sip_connection, id, created_at, and phone_number.
     */
...
export declare namespace ExternalConnections {
    export { type ExternalConnection as ExternalConnection, type ExternalVoiceIntegrationsPaginationMeta as ExternalVoiceIntegrationsPaginationMeta, type ExternalConnectionCreateResponse as ExternalConnectionCreateResponse, type ExternalConnectionRetrieveResponse as ExternalConnectionRetrieveResponse, type ExternalConnectionUpdateResponse as ExternalConnectionUpdateResponse, type ExternalConnectionListResponse as ExternalConnectionListResponse, type ExternalConnectionDeleteResponse as ExternalConnectionDeleteResponse, type ExternalConnectionUpdateLocationResponse as ExternalConnectionUpdateLocationResponse, type ExternalConnectionCreateParams as ExternalConnectionCreateParams, type ExternalConnectionUpdateParams as ExternalConnectionUpdateParams, type ExternalConnectionListParams as ExternalConnectionListParams, type ExternalConnectionUpdateLocationParams as ExternalConnectionUpdateLocationParams, };
    export { LogMessages as LogMessages, type LogMessageRetrieveResponse as LogMessageRetrieveResponse, type LogMessageListResponse as LogMessageListResponse, type LogMessageDismissResponse as LogMessageDismissResponse, type LogMessageListParams as LogMessageListParams, };
    export { CivicAddresses as CivicAddresses, type CivicAddressRetrieveResponse as CivicAddressRetrieveResponse, type CivicAddressListResponse as CivicAddressListResponse, type CivicAddressRetrieveParams as CivicAddressRetrieveParams, type CivicAddressListParams as CivicAddressListParams, };
    export { PhoneNumbers as PhoneNumbers, type ExternalConnectionPhoneNumber as ExternalConnectionPhoneNumber, type PhoneNumberRetrieveResponse as PhoneNumberRetrieveResponse, type PhoneNumberUpdateResponse as PhoneNumberUpdateResponse, type PhoneNumberListResponse as PhoneNumberListResponse, type PhoneNumberRetrieveParams as PhoneNumberRetrieveParams, type PhoneNumberUpdateParams as PhoneNumberUpdateParams, type PhoneNumberListParams as PhoneNumberListParams, };
    export { Releases as Releases, type ReleaseRetrieveResponse as ReleaseRetrieveResponse, type ReleaseListResponse as ReleaseListResponse, type ReleaseRetrieveParams as ReleaseRetrieveParams, type ReleaseListParams as ReleaseListParams, };
    export { Uploads as Uploads, type TnUploadEntry as TnUploadEntry, type Upload as Upload, type UploadCreateResponse as UploadCreateResponse, type UploadRetrieveResponse as UploadRetrieveResponse, type UploadListResponse as UploadListResponse, type UploadPendingCountResponse as UploadPendingCountResponse, type UploadRefreshStatusResponse as UploadRefreshStatusResponse, type UploadRetryResponse as UploadRetryResponse, type UploadCreateParams as UploadCreateParams, type UploadRetrieveParams as UploadRetrieveParams, type UploadListParams as UploadListParams, type UploadRetryParams as UploadRetryParams, };
}
//# sourceMappingURL=external-connections.d.ts.map