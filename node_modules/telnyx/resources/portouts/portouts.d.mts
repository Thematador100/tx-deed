...
import { CommentCreateParams, CommentCreateResponse, CommentListResponse, Comments } from "./comments.mjs";
import * as EventsAPI from "./events.mjs";
import { EventListParams, EventListResponse, EventRetrieveResponse, Events } from "./events.mjs";
import * as ReportsAPI from "./reports.mjs";
import { ExportPortoutsCsvReport, PortoutReport, ReportCreateParams, ReportCreateResponse, ReportListParams, ReportListResponse, ReportRetrieveResponse, Reports } from "./reports.mjs";
import * as SupportingDocumentsAPI from "./supporting-documents.mjs";
import { SupportingDocumentCreateParams, SupportingDocumentCreateResponse, SupportingDocumentListResponse, SupportingDocuments } from "./supporting-documents.mjs";
import { APIPromise } from "../../core/api-promise.mjs";
import { RequestOptions } from "../../internal/request-options.mjs";
export declare class Portouts extends APIResource {
     ...
     * ```
     */
    list(query?: PortoutListParams | null | undefined, options?: RequestOptions): APIPromise<PortoutListResponse>;
    /**
...
export declare namespace PortoutListRejectionCodesResponse {
    interface Data {
        code?: number;
        description?: string;
...
export declare namespace PortoutListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[carrier_name], filter[country_code], filter[country_code_in],
     * filter[foc_date], filter[inserted_at], filter[phone_number], filter[pon],
...
export declare namespace PortoutListRejectionCodesParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally: filter[code],
     * filter[code][in]
     */
...
export declare namespace Portouts {
    export { type PortoutDetails as PortoutDetails, type PortoutRetrieveResponse as PortoutRetrieveResponse, type PortoutListResponse as PortoutListResponse, type PortoutListRejectionCodesResponse as PortoutListRejectionCodesResponse, type PortoutUpdateStatusResponse as PortoutUpdateStatusResponse, type PortoutListParams as PortoutListParams, type PortoutListRejectionCodesParams as PortoutListRejectionCodesParams, type PortoutUpdateStatusParams as PortoutUpdateStatusParams, };
    export { Events as Events, type EventRetrieveResponse as EventRetrieveResponse, type EventListResponse as EventListResponse, type EventListParams as EventListParams, };
    export { Reports as Reports, type ExportPortoutsCsvReport as ExportPortoutsCsvReport, type PortoutReport as PortoutReport, type ReportCreateResponse as ReportCreateResponse, type ReportRetrieveResponse as ReportRetrieveResponse, type ReportListResponse as ReportListResponse, type ReportCreateParams as ReportCreateParams, type ReportListParams as ReportListParams, };
    export { Comments as Comments, type CommentCreateResponse as CommentCreateResponse, type CommentListResponse as CommentListResponse, type CommentCreateParams as CommentCreateParams, };
    export { SupportingDocuments as SupportingDocuments, type SupportingDocumentCreateResponse as SupportingDocumentCreateResponse, type SupportingDocumentListResponse as SupportingDocumentListResponse, type SupportingDocumentCreateParams as SupportingDocumentCreateParams, };
}
//# sourceMappingURL=portouts.d.mts.map