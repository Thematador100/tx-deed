...
export declare class McpServers extends APIResource {
     ...
     * ```
     */
    list(query?: McpServerListParams | null | undefined, options?: RequestOptions): APIPromise<McpServerListResponse>;
    /**
...
export declare namespace McpServerListResponse {
    interface McpServerListResponseItem {
        id: string;
        created_at: string;
        name: string;
        type: string;
