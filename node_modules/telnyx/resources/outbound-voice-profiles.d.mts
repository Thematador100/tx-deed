...
export declare class OutboundVoiceProfiles extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: OutboundVoiceProfileListParams | null | undefined, options?: RequestOptions): APIPromise<OutboundVoiceProfileListResponse>;
    /**
...
export declare namespace OutboundVoiceProfile {
    /**
     * (BETA) Specifies the time window and call limits for calls made using this
     * outbound voice profile. Note that all times are UTC in 24-hour clock time.
     */
...
export declare namespace OutboundVoiceProfileCreateParams {
    /**
     * (BETA) Specifies the time window and call limits for calls made using this
     * outbound voice profile. Note that all times are UTC in 24-hour clock time.
     */
...
export declare namespace OutboundVoiceProfileUpdateParams {
    /**
     * (BETA) Specifies the time window and call limits for calls made using this
     * outbound voice profile.
     */
...
export declare namespace OutboundVoiceProfileListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[name][contains]
     */
