...
export declare class DetailRecords extends APIResource {
    /**
     * Search for any detail record across the Telnyx Platform
     */
    list(query?: DetailRecordListParams | null | undefined, options?: RequestOptions): APIPromise<DetailRecordListResponse>;
}
export interface DetailRecordListResponse {
    data?: Array<DetailRecordListResponse.MessageDetailRecord | DetailRecordListResponse.ConferenceDetailRecord | DetailRecordListResponse.ConferenceParticipantDetailRecord | DetailRecordListResponse.AmdDetailRecord | DetailRecordListResponse.VerifyDetailRecord | DetailRecordListResponse.SimCardUsageDetailRecord | DetailRecordListResponse.MediaStorageDetailRecord>;
    meta?: DetailRecordListResponse.Meta;
}
export declare namespace DetailRecordListResponse {
    ...
    interface ConferenceDetailRecord {
        record_type: string;
        /**
         * Conference id
         */
    ...
    interface ConferenceParticipantDetailRecord {
        record_type: string;
        /**
         * Participant id
         */
    ...
    interface SimCardUsageDetailRecord {
        record_type: string;
        /**
    ...
    interface MediaStorageDetailRecord {
        record_type: string;
        /**
...
export declare namespace DetailRecordListParams {
    /**
     * Filter records on a given record attribute and value. <br/>Example:
     * filter[status]=delivered. <br/>Required: filter[record_type] must be specified.
     */
...
export declare namespace DetailRecords {
    export { type DetailRecordListResponse as DetailRecordListResponse, type DetailRecordListParams as DetailRecordListParams, };
}
//# sourceMappingURL=detail-records.d.mts.map