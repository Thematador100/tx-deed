...
class Actions extends resource_1.APIResource {
     ...
     */
    retrieve(id, options) {
        return this._client.get((0, path_1.path) `/sim_card_actions/${id}`, options);
    }
    /**
     ...
     */
    disable(id, options) {
        return this._client.post((0, path_1.path) `/sim_cards/${id}/actions/disable`, options);
    }
    /**
     ...
     */
    enable(id, options) {
        return this._client.post((0, path_1.path) `/sim_cards/${id}/actions/enable`, options);
    }
    /**
     ...
     * ```
     */
    removePublicIP(id, options) {
        return this._client.post((0, path_1.path) `/sim_cards/${id}/actions/remove_public_ip`, options);
    }
    /**
     ...
     * ```
     */
    setPublicIP(id, params = {}, options) {
        const { region_code } = params ?? {};
        return this._client.post((0, path_1.path) `/sim_cards/${id}/actions/set_public_ip`, {
            query: { region_code },
            ...options,
        });
    }
     ...
     * ```
     */
    setStandby(id, options) {
        return this._client.post((0, path_1.path) `/sim_cards/${id}/actions/set_standby`, options);
    }
    /**
     ...
     * ```
     */
    validateRegistrationCodes(body, options) {
