...
import { Building2, Menu, X, LayoutDashboard, LogOut, Search, ChevronDown, ShoppingCart, Bot, ShieldCheck, UploadCloud, Columns, Calendar, Bell, HeartHandshake as Handshake, UserCheck, Users, FileSearch, Terminal, Zap, Briefcase, ListFilter, FileClock, Rocket, CalendarDays, Home, Plus } from 'lucide-react';
...
const Navbar = () => {
  ...
  const guestNav = [
    { name: 'Home', path: '/' },
    { name: 'Upcoming Sales', path: '/upcoming-sales' },
    ...
    dropdowns: [
      {
        ...
        items: [
          ...
          { name: 'Upcoming Sales (US)', path: '/upcoming-sales', icon: CalendarDays },
      ...
      },
      {
        ...
        icon: Home,
        items: [
          { name: 'View My Listings', path: '/my-listings', icon: Home },
          { name: 'Add New Listing', path: '/add-listing', icon: Plus },
        ]
      },
      {
        title: 'Deal Tools',
