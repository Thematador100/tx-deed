...
export declare class ExternalVetting extends APIResource {
    /**
     ...
     * ```
     */
    import(brandID: string, body: ExternalVettingImportParams, options?: RequestOptions): APIPromise<ExternalVettingImportResponse>;
    /**
