...
export declare class RoomCompositions extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: RoomCompositionListParams | null | undefined, options?: RequestOptions): APIPromise<RoomCompositionListResponse>;
    /**
...
export declare namespace RoomCompositionListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[date_created_at][eq], filter[date_created_at][gte],
     * filter[date_created_at][lte], filter[session_id], filter[status]
...
export declare namespace RoomCompositions {
    export { type RoomComposition as RoomComposition, type VideoRegion as VideoRegion, type RoomCompositionCreateResponse as RoomCompositionCreateResponse, type RoomCompositionRetrieveResponse as RoomCompositionRetrieveResponse, type RoomCompositionListResponse as RoomCompositionListResponse, type RoomCompositionCreateParams as RoomCompositionCreateParams, type RoomCompositionListParams as RoomCompositionListParams, };
}
//# sourceMappingURL=room-compositions.d.mts.map