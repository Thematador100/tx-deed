...
export declare class FqdnConnections extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: FqdnConnectionListParams | null | undefined, options?: RequestOptions): APIPromise<FqdnConnectionListResponse>;
    /**
...
export declare namespace FqdnConnectionListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[connection_name], filter[fqdn], filter[outbound_voice_profile_id],
     * filter[outbound.outbound_voice_profile_id]
