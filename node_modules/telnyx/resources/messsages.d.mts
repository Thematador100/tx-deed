...
import * as MesssagesAPI from "./messsages.mjs";
import { APIPromise } from "../core/api-promise.mjs";
import { RequestOptions } from "../internal/request-options.mjs";
export declare class Messsages extends APIResource {
    /**
     * Send an RCS message
     *
     * @example
...
export declare namespace RcsAgentMessage {
...
export declare namespace RcsCardContent {
    /**
     * A media file within a rich card.
     */
    interface Media {
...
export declare namespace RcsSuggestion {
    /**
     * When tapped, initiates the corresponding native action on the device.
     */
    interface Action {
...
export declare namespace MesssageRcsResponse {
    interface Data {
        /**
         * message ID
         */
...
export declare namespace MesssageRcsParams {
    interface MmsFallback {
        /**
         * Phone number in +E.164 format
         */
        from?: string;
...
export declare namespace Messsages {
    export { type RcsAgentMessage as RcsAgentMessage, type RcsCardContent as RcsCardContent, type RcsContentInfo as RcsContentInfo, type RcsSuggestion as RcsSuggestion, type MesssageRcsResponse as MesssageRcsResponse, type MesssageRcsParams as MesssageRcsParams, };
}
//# sourceMappingURL=messsages.d.mts.map