...
export declare class AvailablePhoneNumbers extends APIResource {
    /**
...
export declare namespace AvailablePhoneNumberListResponse {
    interface Data {
        /**
...
export declare namespace AvailablePhoneNumberListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[phone_number], filter[locality], filter[administrative_area],
     * filter[country_code], filter[national_destination_code], filter[rate_center],
...
export declare namespace AvailablePhoneNumbers {
    export { type AvailablePhoneNumberListResponse as AvailablePhoneNumberListResponse, type AvailablePhoneNumberListParams as AvailablePhoneNumberListParams, };
}
//# sourceMappingURL=available-phone-numbers.d.mts.map