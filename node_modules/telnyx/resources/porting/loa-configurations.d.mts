...
export declare class LoaConfigurations extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: LoaConfigurationListParams | null | undefined, options?: RequestOptions): APIPromise<LoaConfigurationListResponse>;
    /**
...
export declare namespace PortingLoaConfiguration {
    /**
     * The address of the company.
     */
    interface Address {
...
export declare namespace LoaConfigurationCreateParams {
    /**
     * The address of the company.
     */
    interface Address {
...
export declare namespace LoaConfigurationUpdateParams {
    /**
     * The address of the company.
     */
    interface Address {
...
export declare namespace LoaConfigurationListParams {
    /**
     * Consolidated page parameter (deepObject style). Originally: page[size],
     * page[number]
     */
...
export declare namespace LoaConfigurationPreview0Params {
    /**
     * The address of the company.
     */
    interface Address {
