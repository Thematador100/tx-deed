...
const enum_1 = require("./resources/enum.js");
...
const messsages_1 = require("./resources/messsages.js");
...
const partner_campaigns_1 = require("./resources/partner-campaigns.js");
const phone_number_assignment_by_profile_1 = require("./resources/phone-number-assignment-by-profile.js");
const phone_number_campaigns_1 = require("./resources/phone-number-campaigns.js");
...
const brand_1 = require("./resources/brand/brand.js");
const bundle_pricing_1 = require("./resources/bundle-pricing/bundle-pricing.js");
const calls_1 = require("./resources/calls/calls.js");
const campaign_builder_1 = require("./resources/campaign-builder/campaign-builder.js");
const campaign_1 = require("./resources/campaign/campaign.js");
...
class Telnyx {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('TELNYX_BASE_URL'), apiKey = (0, env_1.readEnv)('TELNYX_API_KEY'), publicKey = (0, env_1.readEnv)('TELNYX_PUBLIC_KEY') ?? null, ...opts } = {}) {
        ...
        this.campaign = new API.Campaign(this);
        this.campaignBuilder = new API.CampaignBuilder(this);
        ...
        this.messsages = new API.Messsages(this);
        ...
        this.phoneNumberAssignmentByProfile = new API.PhoneNumberAssignmentByProfile(this);
        this.phoneNumberBlocks = new API.PhoneNumberBlocks(this);
        this.phoneNumberCampaigns = new API.PhoneNumberCampaigns(this);
        ...
        this.partnerCampaigns = new API.PartnerCampaigns(this);
        this.wellKnown = new API.WellKnown(this);
        if (apiKey === undefined) {
            throw new Errors.TelnyxError("The TELNYX_API_KEY environment variable is missing or empty; either provide it, or instantiate the Telnyx client with an apiKey option, like new Telnyx({ apiKey: 'My API Key' }).");
        }
        const options = {
            apiKey,
            publicKey,
...
Telnyx.Campaign = campaign_1.Campaign;
Telnyx.CampaignBuilder = campaign_builder_1.CampaignBuilder;
...
Telnyx.Messsages = messsages_1.Messsages;
...
Telnyx.PhoneNumberAssignmentByProfile = phone_number_assignment_by_profile_1.PhoneNumberAssignmentByProfile;
Telnyx.PhoneNumberBlocks = phone_number_blocks_1.PhoneNumberBlocks;
Telnyx.PhoneNumberCampaigns = phone_number_campaigns_1.PhoneNumberCampaigns;
...
Telnyx.PartnerCampaigns = partner_campaigns_1.PartnerCampaigns;
