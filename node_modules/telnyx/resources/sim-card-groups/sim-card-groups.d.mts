...
import * as SimCardGroupsAPI from "./sim-card-groups.mjs";
import * as AuthenticationProvidersAPI from "../authentication-providers.mjs";
import * as ActionsAPI from "./actions.mjs";
import { ActionListParams, ActionListResponse, ActionRemovePrivateWirelessGatewayResponse, ActionRemoveWirelessBlocklistResponse, ActionRetrieveResponse, ActionSetPrivateWirelessGatewayParams, ActionSetPrivateWirelessGatewayResponse, ActionSetWirelessBlocklistParams, ActionSetWirelessBlocklistResponse, Actions, SimCardGroupAction } from "./actions.mjs";
import { APIPromise } from "../../core/api-promise.mjs";
import { RequestOptions } from "../../internal/request-options.mjs";
export declare class SimCardGroups extends APIResource {
     ...
     * ```
     */
    list(query?: SimCardGroupListParams | null | undefined, options?: RequestOptions): APIPromise<SimCardGroupListResponse>;
    /**
...
export declare namespace SimCardGroup {
    /**
     * Upper limit on the amount of data the SIM cards, within the group, can use.
     */
    interface DataLimit {
...
export declare namespace SimCardGroupListResponse {
    interface Data {
        /**
         * Identifies the resource.
         */
...
export declare namespace SimCardGroupCreateParams {
    /**
     * Upper limit on the amount of data the SIM cards, within the group, can use.
     */
    interface DataLimit {
...
export declare namespace SimCardGroupUpdateParams {
    /**
     * Upper limit on the amount of data the SIM cards, within the group, can use.
     */
    interface DataLimit {
...
export declare namespace SimCardGroups {
    export { type ConsumedData as ConsumedData, type SimCardGroup as SimCardGroup, type SimCardGroupCreateResponse as SimCardGroupCreateResponse, type SimCardGroupRetrieveResponse as SimCardGroupRetrieveResponse, type SimCardGroupUpdateResponse as SimCardGroupUpdateResponse, type SimCardGroupListResponse as SimCardGroupListResponse, type SimCardGroupDeleteResponse as SimCardGroupDeleteResponse, type SimCardGroupCreateParams as SimCardGroupCreateParams, type SimCardGroupRetrieveParams as SimCardGroupRetrieveParams, type SimCardGroupUpdateParams as SimCardGroupUpdateParams, type SimCardGroupListParams as SimCardGroupListParams, };
    export { Actions as Actions, type SimCardGroupAction as SimCardGroupAction, type ActionRetrieveResponse as ActionRetrieveResponse, type ActionListResponse as ActionListResponse, type ActionRemovePrivateWirelessGatewayResponse as ActionRemovePrivateWirelessGatewayResponse, type ActionRemoveWirelessBlocklistResponse as ActionRemoveWirelessBlocklistResponse, type ActionSetPrivateWirelessGatewayResponse as ActionSetPrivateWirelessGatewayResponse, type ActionSetWirelessBlocklistResponse as ActionSetWirelessBlocklistResponse, type ActionListParams as ActionListParams, type ActionSetPrivateWirelessGatewayParams as ActionSetPrivateWirelessGatewayParams, type ActionSetWirelessBlocklistParams as ActionSetWirelessBlocklistParams, };
}
//# sourceMappingURL=sim-card-groups.d.mts.map