...
import HillsboroughScraper from '@/pages/admin/HillsboroughScraper';
      ...
      <Router>
        <div className="min-h-screen bg-white text-slate-800 flex flex-col">
          ...
          <Routes>
            ...
            <Route path="/admin/hillsborough-scraper" element={<AdminRoute><AdminLayout><HillsboroughScraper /></AdminLayout></AdminRoute>} />
