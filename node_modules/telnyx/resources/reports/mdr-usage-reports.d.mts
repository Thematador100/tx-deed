...
export declare class MdrUsageReports extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: MdrUsageReportListParams | null | undefined, options?: RequestOptions): APIPromise<MdrUsageReportListResponse>;
    /**
...
export declare namespace MdrUsageReport {
    interface Result {
...
export declare namespace MdrUsageReportListParams {
    /**
     * Consolidated page parameter (deepObject style). Originally: page[number],
     * page[size]
     */
