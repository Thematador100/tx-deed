...
import * as ExternalConnectionsAPI from "./external-connections.mjs";
...
export declare class Uploads extends APIResource {
     ...
     * ```
     */
    list(id: string, query?: UploadListParams | null | undefined, options?: RequestOptions): APIPromise<UploadListResponse>;
    /**
...
export declare namespace UploadPendingCountResponse {
    interface Data {
        /**
...
export declare namespace UploadListParams {
    /**
     * Filter parameter for uploads (deepObject style). Supports filtering by status,
     * civic_address_id, location_id, and phone_number with eq/contains operations.
     */
