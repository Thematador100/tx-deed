...
export declare class SimCardOrders extends APIResource {
    /**
     ...
     * ```
     */
    list(query?: SimCardOrderListParams | null | undefined, options?: RequestOptions): APIPromise<SimCardOrderListResponse>;
}
...
export declare namespace SimCardOrder {
    /**
     * An object representing the total cost of the order.
     */
    interface Cost {
...
export declare namespace SimCardOrderListParams {
    /**
     * Consolidated filter parameter for SIM card orders (deepObject style).
     * Originally: filter[created_at], filter[updated_at], filter[quantity],
     * filter[cost.amount], filter[cost.currency], filter[address.id],
...
//# sourceMappingURL=sim-card-orders.d.mts.map