...
import { ActionCheckRegistrationStatusResponse, Actions } from "./actions.js";
import { APIPromise } from "../../core/api-promise.js";
import { RequestOptions } from "../../internal/request-options.js";
export declare class CredentialConnections extends APIResource {
     ...
     * ```
     */
    list(query?: CredentialConnectionListParams | null | undefined, options?: RequestOptions): APIPromise<CredentialConnectionListResponse>;
    /**
...
export declare namespace CredentialConnectionListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[connection_name], filter[fqdn], filter[outbound_voice_profile_id],
     * filter[outbound.outbound_voice_profile_id]
