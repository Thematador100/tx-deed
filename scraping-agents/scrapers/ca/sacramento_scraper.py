"""
Sacramento County, California Tax Deed/Lien Scraper
...
class SacramentoScraper(BaseScraper):
    """Scraper for Sacramento County, California"""

    def __init__(self):
        super().__init__(
            county_name="Sacramento",
            state_code="CA",
            base_url="https://www.treasurer.saccounty.net"
        )
