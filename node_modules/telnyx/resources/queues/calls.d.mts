...
export declare class Calls extends APIResource {
     ...
     * ```
     */
    list(queueName: string, query?: CallListParams | null | undefined, options?: RequestOptions): APIPromise<CallListResponse>;
    /**
...
export declare namespace CallRetrieveResponse {
    interface Data {
        /**
...
export declare namespace Calls {
    export { type CallRetrieveResponse as CallRetrieveResponse, type CallListResponse as CallListResponse, type CallRetrieveParams as CallRetrieveParams, type CallUpdateParams as CallUpdateParams, type CallListParams as CallListParams, type CallRemoveParams as CallRemoveParams, };
}
