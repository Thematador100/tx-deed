...
export declare class RoomRecordings extends APIResource {
    /**
     ...
     */
    list(query?: RoomRecordingListParams | null | undefined, options?: RequestOptions): APIPromise<RoomRecordingListResponse>;
    /**
...
export declare namespace RoomRecordingRetrieveResponse {
    interface Data {
        /**
...
export declare namespace RoomRecordingListResponse {
    interface Data {
        /**
         * A unique identifier for the room recording.
         */
...
export declare namespace RoomRecordingDeleteBulkResponse {
    interface Data {
        /**
...
export declare namespace RoomRecordingListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[date_ended_at][eq], filter[date_ended_at][gte],
     * filter[date_ended_at][lte], filter[date_started_at][eq],
...
export declare namespace RoomRecordingDeleteBulkParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[date_ended_at][eq], filter[date_ended_at][gte],
     * filter[date_ended_at][lte], filter[date_started_at][eq],
