...
export interface TranscriptionStartRequest {
    ...
    transcription_engine_config?: TranscriptionStartRequest.TranscriptionEngineGoogleConfig | TranscriptionStartRequest.TranscriptionEngineTelnyxConfig | TranscriptionStartRequest.TranscriptionEngineDeepgramConfig | TranscriptionEngineAConfig | TranscriptionEngineBConfig;
    /**
...
export declare namespace TranscriptionStartRequest {
    interface TranscriptionEngineGoogleConfig {
        /**
         * Enables speaker diarization.
         */
        enable_speaker_diarization?: boolean;
    ...
    namespace TranscriptionEngineGoogleConfig {
        interface SpeechContext {
            /**
             * Boost factor for the speech context.
             */
    ...
    interface TranscriptionEngineTelnyxConfig {
        /**
         * Language to use for speech recognition
         */
    ...
    interface TranscriptionEngineDeepgramConfig {
        /**
...
export interface ActionStartTranscriptionParams {
     ...
     */
    transcription_engine?: 'Google' | 'Telnyx' | 'Deepgram' | 'A' | 'B';
    transcription_engine_config?: ActionStartTranscriptionParams.TranscriptionEngineGoogleConfig | ActionStartTranscriptionParams.TranscriptionEngineTelnyxConfig | ActionStartTranscriptionParams.TranscriptionEngineDeepgramConfig | TranscriptionEngineAConfig | TranscriptionEngineBConfig;
    /**
     * Indicates which leg of the call will be transcribed. Use `inbound` for the leg
     * that requested the transcription, `outbound` for the other leg, and `both` for
     * both legs of the call. Will default to `inbound`.
