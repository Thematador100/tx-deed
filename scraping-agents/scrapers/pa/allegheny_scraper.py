"""
Allegheny County, Pennsylvania Tax Deed/Lien Scraper
...
class AlleghenyScraper(BaseScraper):
    """Scraper for Allegheny County, Pennsylvania"""

    def __init__(self):
        super().__init__(
            county_name="Allegheny",
            state_code="PA",
            base_url="https://www.alleghenycounty.us/treasury"
        )
